...
public enum EnumMobs
{
    ...
    SPIDERJOCKEY("Skeleton", false, 8, 32, "textures/entity/skeleton/skeleton.png", "textures/entity/spider/spider.png", true, false), 
    SPIDERJOCKEYWITHER("Skeleton", false, 8, 32, "textures/entity/skeleton/wither_skeleton.png", "textures/entity/spider/spider.png", true, false), 
    ...
    private EnumMobs(final String name, final boolean topLevelUnit, final int expectedWidth, final int squaredSize, final String path, final String secondaryPath, final boolean isHostile, final boolean isNeutral) {
        this.name = name;
    ...
    public static EnumMobs getMobByName(final String par0) {
        for (final EnumMobs var4 : values()) {
