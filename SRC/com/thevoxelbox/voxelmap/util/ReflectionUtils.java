...
public class ReflectionUtils
{
    ...
    public static ArrayList<Field> getFieldsByType(final Object o, final Class objectClassBaseType, final Class fieldClasstype) {
        final ArrayList<Field> matches = new ArrayList<Field>();
