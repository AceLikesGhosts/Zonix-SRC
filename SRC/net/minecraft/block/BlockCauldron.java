...
public class BlockCauldron extends Block
{
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.field_150029_a = p_149651_1_.registerIcon(this.getTextureName() + "_inner");
        this.field_150028_b = p_149651_1_.registerIcon(this.getTextureName() + "_top");
        this.field_150030_M = p_149651_1_.registerIcon(this.getTextureName() + "_bottom");
        this.blockIcon = p_149651_1_.registerIcon(this.getTextureName() + "_side");
    }
    
    public static IIcon func_150026_e(final String p_150026_0_) {
    ...
    public void onEntityCollidedWithBlock(final World p_149670_1_, final int p_149670_2_, final int p_149670_3_, final int p_149670_4_, final Entity p_149670_5_) {
        final int var6 = func_150027_b(p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_, p_149670_4_));
    ...
    public boolean onBlockActivated(final World p_149727_1_, final int p_149727_2_, final int p_149727_3_, final int p_149727_4_, final EntityPlayer p_149727_5_, final int p_149727_6_, final float p_149727_7_, final float p_149727_8_, final float p_149727_9_) {
        ...
        final int var11 = p_149727_1_.getBlockMetadata(p_149727_2_, p_149727_3_, p_149727_4_);
        ...
        if (var10.getItem() == Items.glass_bottle) {
            if (var12 > 0) {
                if (!p_149727_5_.capabilities.isCreativeMode) {
                    final ItemStack var13 = new ItemStack(Items.potionitem, 1, 0);
                    if (!p_149727_5_.inventory.addItemStackToInventory(var13)) {
                        p_149727_1_.spawnEntityInWorld(new EntityItem(p_149727_1_, p_149727_2_ + 0.5, p_149727_3_ + 1.5, p_149727_4_ + 0.5, var13));
                    }
    ...
    public void func_150024_a(final World p_150024_1_, final int p_150024_2_, final int p_150024_3_, final int p_150024_4_, final int p_150024_5_) {
    ...
    public void fillWithRain(final World p_149639_1_, final int p_149639_2_, final int p_149639_3_, final int p_149639_4_) {
        if (p_149639_1_.rand.nextInt(20) == 1) {
            final int var5 = p_149639_1_.getBlockMetadata(p_149639_2_, p_149639_3_, p_149639_4_);
            if (var5 < 3) {
    ...
    public static int func_150027_b(final int p_150027_0_) {
        return p_150027_0_;
    }
    
    public static float func_150025_c(final int p_150025_0_) {
