...
public class BlockHugeMushroom extends Block
{
    ...
    public BlockHugeMushroom(final Material p_i45412_1_, final int p_i45412_2_) {
        super(p_i45412_1_);
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.field_149794_M = new IIcon[BlockHugeMushroom.field_149793_a.length];
        for (int var2 = 0; var2 < this.field_149794_M.length; ++var2) {
            this.field_149794_M[var2] = p_149651_1_.registerIcon(this.getTextureName() + "_" + BlockHugeMushroom.field_149793_a[var2]);
        }
        this.field_149796_O = p_149651_1_.registerIcon(this.getTextureName() + "_inside");
        this.field_149795_N = p_149651_1_.registerIcon(this.getTextureName() + "_skin_stem");
    }
    
    static {
        field_149793_a = new String[] { "skin_brown", "skin_red" };
    }
}
