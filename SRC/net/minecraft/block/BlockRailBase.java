...
public abstract class BlockRailBase extends Block
{
    ...
    public static final boolean func_150049_b_(final World p_150049_0_, final int p_150049_1_, final int p_150049_2_, final int p_150049_3_) {
        return func_150051_a(p_150049_0_.getBlock(p_150049_1_, p_150049_2_, p_150049_3_));
    }
    
    public static final boolean func_150051_a(final Block p_150051_0_) {
    ...
    public void onNeighborBlockChange(final World p_149695_1_, final int p_149695_2_, final int p_149695_3_, final int p_149695_4_, final Block p_149695_5_) {
        if (!p_149695_1_.isClient) {
            int var7;
            final int var6 = var7 = p_149695_1_.getBlockMetadata(p_149695_2_, p_149695_3_, p_149695_4_);
            if (this.field_150053_a) {
                var7 = (var6 & 0x7);
            }
            boolean var8 = false;
    ...
    protected void func_150052_a(final World p_150052_1_, final int p_150052_2_, final int p_150052_3_, final int p_150052_4_, final boolean p_150052_5_) {
    ...
    public class Rail
    {
        ...
        public Rail(final World p_i45388_2_, final int p_i45388_3_, final int p_i45388_4_, final int p_i45388_5_) {
            ...
            final Block var6 = p_i45388_2_.getBlock(p_i45388_3_, p_i45388_4_, p_i45388_5_);
        ...
        private void func_150648_a(final int p_150648_1_) {
        ...
        private void func_150651_b() {
            for (int var1 = 0; var1 < this.field_150657_g.size(); ++var1) {
                final Rail var2 = this.func_150654_a(this.field_150657_g.get(var1));
        ...
        private boolean func_150646_a(final int p_150646_1_, final int p_150646_2_, final int p_150646_3_) {
        ...
        private boolean func_150652_b(final int p_150652_1_, final int p_150652_2_, final int p_150652_3_) {
            for (int var4 = 0; var4 < this.field_150657_g.size(); ++var4) {
                final ChunkPosition var5 = this.field_150657_g.get(var4);
        ...
        private boolean func_150649_b(final Rail p_150649_1_) {
            return this.func_150653_a(p_150649_1_) || (this.field_150657_g.size() != 2 && (!this.field_150657_g.isEmpty() || true));
        }
        ...
        private void func_150645_c(final Rail p_150645_1_) {
            ...
            final boolean var2 = this.func_150652_b(this.field_150661_c, this.field_150658_d, this.field_150659_e - 1);
            final boolean var3 = this.func_150652_b(this.field_150661_c, this.field_150658_d, this.field_150659_e + 1);
            final boolean var4 = this.func_150652_b(this.field_150661_c - 1, this.field_150658_d, this.field_150659_e);
            final boolean var5 = this.func_150652_b(this.field_150661_c + 1, this.field_150658_d, this.field_150659_e);
            byte var6 = -1;
            if (var2 || var3) {
                var6 = 0;
            }
            ...
            int var7 = var6;
            if (this.field_150656_f) {
                var7 = ((this.field_150660_b.getBlockMetadata(this.field_150661_c, this.field_150658_d, this.field_150659_e) & 0x8) | var6);
            }
            this.field_150660_b.setBlockMetadataWithNotify(this.field_150661_c, this.field_150658_d, this.field_150659_e, var7, 3);
        }
        
        private boolean func_150647_c(final int p_150647_1_, final int p_150647_2_, final int p_150647_3_) {
            final Rail var4 = this.func_150654_a(new ChunkPosition(p_150647_1_, p_150647_2_, p_150647_3_));
            if (var4 == null) {
                return false;
            }
            var4.func_150651_b();
        ...
        public void func_150655_a(final boolean p_150655_1_, final boolean p_150655_2_) {
            final boolean var3 = this.func_150647_c(this.field_150661_c, this.field_150658_d, this.field_150659_e - 1);
            final boolean var4 = this.func_150647_c(this.field_150661_c, this.field_150658_d, this.field_150659_e + 1);
            final boolean var5 = this.func_150647_c(this.field_150661_c - 1, this.field_150658_d, this.field_150659_e);
            final boolean var6 = this.func_150647_c(this.field_150661_c + 1, this.field_150658_d, this.field_150659_e);
            byte var7 = -1;
            ...
            int var8 = var7;
            if (this.field_150656_f) {
                var8 = ((this.field_150660_b.getBlockMetadata(this.field_150661_c, this.field_150658_d, this.field_150659_e) & 0x8) | var7);
            }
            if (p_150655_2_ || this.field_150660_b.getBlockMetadata(this.field_150661_c, this.field_150658_d, this.field_150659_e) != var8) {
                ...
                for (int var9 = 0; var9 < this.field_150657_g.size(); ++var9) {
                    final Rail var10 = this.func_150654_a(this.field_150657_g.get(var9));
                    if (var10 != null) {
                        var10.func_150651_b();
