...
{
    private final Random field_147679_a;
    ...
    public MusicTicker(final Minecraft p_i45112_1_) {
        this.field_147679_a = new Random();
    ...
    @Override
    public void update() {
        final MusicType var1 = this.field_147677_b.func_147109_W();
    ...
    public enum MusicType
    {
        ...
        private MusicType(final String p_i45111_1_, final int p_i45111_2_, final ResourceLocation p_i45111_3_, final int p_i45111_4_, final int p_i45111_5_) {
