...
public class GuiLanguage extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.field_146450_f = new List()).func_148134_d(7, 8);
    }
    ...
    class List extends GuiSlot
    {
        ...
        public List() {
            ...
            for (final Language var3 : GuiLanguage.this.field_146454_h.getLanguages()) {
        ...
        protected void elementClicked(final int p_148144_1_, final boolean p_148144_2_, final int p_148144_3_, final int p_148144_4_) {
            final Language var5 = this.field_148177_m.get(this.field_148176_l.get(p_148144_1_));
        ...
        protected void drawSlot(final int p_148126_1_, final int p_148126_2_, final int p_148126_3_, final int p_148126_4_, final Tessellator p_148126_5_, final int p_148126_6_, final int p_148126_7_) {
            ...
            GuiLanguage.this.drawCenteredString(GuiLanguage.this.fontRendererObj, this.field_148177_m.get(this.field_148176_l.get(p_148126_1_)).toString(), this.field_148155_a / 2, p_148126_3_ + 1, 16777215);
