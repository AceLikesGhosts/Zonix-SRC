...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options var5 : GuiOptions.field_146440_f) {
            if (var5.getEnumFloat()) {
                ...
                final GuiOptionButton var6 = new GuiOptionButton(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 12 + 24 * (var1 >> 1), var5, this.field_146443_h.getKeyBinding(var5));
        ...
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Super Secret Settings...") {
            ...
            public void func_146113_a(final SoundHandler p_146113_1_) {
                final SoundEventAccessorComposite var2 = p_146113_1_.func_147686_a(SoundCategory.ANIMALS, SoundCategory.BLOCKS, SoundCategory.MOBS, SoundCategory.PLAYERS, SoundCategory.WEATHER);
                if (var2 != null) {
    ...
    protected void actionPerformed(final GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            ...
            if (p_146284_1_.id == 107) {
                this.mc.gameSettings.saveOptions();
                final IStream var2 = this.mc.func_152346_Z();
    ...
    static {
        field_146440_f = new GameSettings.Options[] { GameSettings.Options.FOV, GameSettings.Options.DIFFICULTY };
    }
}
