...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiSelectWorld(final GuiScreen p_i1054_1_) {
        ...
        this.field_146635_w = new String[3];
    ...
    public void initGui() {
        ...
        (this.field_146638_t = new List()).func_148134_d(4, 5);
        this.func_146618_g();
    }
    ...
    protected void actionPerformed(final GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id == 2) {
                ...
                final ISaveHandler var5 = this.mc.getSaveLoader().getSaveLoader(this.func_146621_a(this.field_146640_r), false);
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(final int p_148126_1_, final int p_148126_2_, final int p_148126_3_, final int p_148126_4_, final Tessellator p_148126_5_, final int p_148126_6_, final int p_148126_7_) {
            final SaveFormatComparator var8 = GuiSelectWorld.this.field_146639_s.get(p_148126_1_);
