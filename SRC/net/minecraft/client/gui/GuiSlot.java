...
public abstract class GuiSlot
{
    ...
    public GuiSlot(final Minecraft p_i1052_1_, final int p_i1052_2_, final int p_i1052_3_, final int p_i1052_4_, final int p_i1052_5_, final int p_i1052_6_) {
    ...
    public void func_148128_a(final int p_148128_1_, final int p_148128_2_, final float p_148128_3_) {
        ...
        var16.addVertexWithUV(this.field_148152_e, this.field_148154_c, 0.0, this.field_148152_e / var17, (this.field_148154_c + (int)this.field_148169_q) / var17);
        var16.addVertexWithUV(this.field_148151_d, this.field_148154_c, 0.0, this.field_148151_d / var17, (this.field_148154_c + (int)this.field_148169_q) / var17);
        var16.addVertexWithUV(this.field_148151_d, this.field_148153_b, 0.0, this.field_148151_d / var17, (this.field_148153_b + (int)this.field_148169_q) / var17);
        var16.addVertexWithUV(this.field_148152_e, this.field_148153_b, 0.0, this.field_148152_e / var17, (this.field_148153_b + (int)this.field_148169_q) / var17);
        var16.draw();
        ...
        var16.addVertexWithUV(this.field_148152_e, this.field_148153_b + var18, 0.0, 0.0, 1.0);
        var16.addVertexWithUV(this.field_148151_d, this.field_148153_b + var18, 0.0, 1.0, 1.0);
        var16.setColorRGBA_I(0, 255);
        var16.addVertexWithUV(this.field_148151_d, this.field_148153_b, 0.0, 1.0, 0.0);
        var16.addVertexWithUV(this.field_148152_e, this.field_148153_b, 0.0, 0.0, 0.0);
        var16.draw();
        var16.startDrawingQuads();
        var16.setColorRGBA_I(0, 255);
        var16.addVertexWithUV(this.field_148152_e, this.field_148154_c, 0.0, 0.0, 1.0);
        var16.addVertexWithUV(this.field_148151_d, this.field_148154_c, 0.0, 1.0, 1.0);
        var16.setColorRGBA_I(0, 0);
        var16.addVertexWithUV(this.field_148151_d, this.field_148154_c - var18, 0.0, 1.0, 0.0);
        var16.addVertexWithUV(this.field_148152_e, this.field_148154_c - var18, 0.0, 0.0, 0.0);
        var16.draw();
        int var13 = this.func_148135_f();
        if (var13 > 0) {
            ...
            var16.startDrawingQuads();
            var16.setColorRGBA_I(0, 255);
            var16.addVertexWithUV(var5, this.field_148154_c, 0.0, 0.0, 1.0);
            var16.addVertexWithUV(var6, this.field_148154_c, 0.0, 1.0, 1.0);
            var16.addVertexWithUV(var6, this.field_148153_b, 0.0, 1.0, 0.0);
            var16.addVertexWithUV(var5, this.field_148153_b, 0.0, 0.0, 0.0);
            var16.draw();
            var16.startDrawingQuads();
            var16.setColorRGBA_I(8421504, 255);
            var16.addVertexWithUV(var5, var19 + var14, 0.0, 0.0, 1.0);
            var16.addVertexWithUV(var6, var19 + var14, 0.0, 1.0, 1.0);
            var16.addVertexWithUV(var6, var19, 0.0, 1.0, 0.0);
            var16.addVertexWithUV(var5, var19, 0.0, 0.0, 0.0);
            var16.draw();
            var16.startDrawingQuads();
            var16.setColorRGBA_I(12632256, 255);
            var16.addVertexWithUV(var5, var19 + var14 - 1, 0.0, 0.0, 1.0);
            var16.addVertexWithUV(var6 - 1, var19 + var14 - 1, 0.0, 1.0, 1.0);
            var16.addVertexWithUV(var6 - 1, var19, 0.0, 1.0, 0.0);
            var16.addVertexWithUV(var5, var19, 0.0, 0.0, 0.0);
            var16.draw();
        }
    ...
    private void func_148136_c(final int p_148136_1_, final int p_148136_2_, final int p_148136_3_, final int p_148136_4_) {
        ...
        var5.addVertexWithUV(this.field_148152_e, p_148136_2_, 0.0, 0.0, p_148136_2_ / var6);
        var5.addVertexWithUV(this.field_148152_e + this.field_148155_a, p_148136_2_, 0.0, this.field_148155_a / var6, p_148136_2_ / var6);
        var5.setColorRGBA_I(4210752, p_148136_3_);
        var5.addVertexWithUV(this.field_148152_e + this.field_148155_a, p_148136_1_, 0.0, this.field_148155_a / var6, p_148136_1_ / var6);
        var5.addVertexWithUV(this.field_148152_e, p_148136_1_, 0.0, 0.0, p_148136_1_ / var6);
        var5.draw();
    }
