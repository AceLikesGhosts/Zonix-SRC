...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(final FontRenderer p_i46392_1_, final int p_i46392_2_, final int p_i46392_3_, final int p_i46392_4_, final int p_i46392_5_) {
        this.field_146216_j = "";
    ...
    public void func_146191_b(final String p_146191_1_) {
        String var2 = "";
        final String var3 = ChatAllowedCharacters.filerAllowedCharacters(p_146191_1_);
        ...
        if (this.field_146216_j.length() > 0) {
            var2 += this.field_146216_j.substring(0, var4);
        }
        int var8;
        if (var6 < var3.length()) {
        ...
        if (this.field_146216_j.length() != 0) {
            if (this.field_146223_s != this.field_146224_r) {
                ...
                if (var4 < this.field_146216_j.length()) {
                    var5 += this.field_146216_j.substring(var4);
                }
        ...
        if (this.func_146176_q()) {
            ...
            if (var6) {
                if (var11) {
                    ...
                    this.field_146211_a.drawStringWithShadow("_", var12, var8, var1);
                }
            }
            if (var3 != var2) {
                final int var13 = var7 + this.field_146211_a.getStringWidth(var4.substring(0, var3));
