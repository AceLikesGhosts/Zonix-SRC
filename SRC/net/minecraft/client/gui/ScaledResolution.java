...
public class ScaledResolution
{
    ...
    public ScaledResolution(final Minecraft minecraft) {
        this(minecraft, minecraft.displayWidth, minecraft.displayHeight);
    }
    
    public ScaledResolution(final Minecraft p_i46324_1_, final int p_i46324_2_, final int p_i46324_3_) {
        this.scaledWidth = p_i46324_2_;
        this.scaledHeight = p_i46324_3_;
        this.scaleFactor = 1;
        final boolean var4 = p_i46324_1_.func_152349_b();
