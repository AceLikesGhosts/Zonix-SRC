...
public class ScreenChatOptions extends GuiScreen
{
    ...
    private static final GameSettings.Options[] field_146395_f;
    ...
    public void initGui() {
        ...
        var1 += 2;
        for (final GameSettings.Options var5 : ScreenChatOptions.field_146395_f) {
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 + 24 * (var1 >> 1), var5));
            }
            else {
    ...
    static {
        ...
        field_146395_f = new GameSettings.Options[] { GameSettings.Options.SHOW_CAPE };
    }
}
