...
public class ServerSelectionList extends GuiListExtended
{
    ...
    private final IGuiListEntry field_148196_n;
    private int field_148197_o;
    private static final String __OBFID = "CL_00000819";
    
    public ServerSelectionList(final GuiMultiplayer p_i45049_1_, final Minecraft p_i45049_2_, final int p_i45049_3_, final int p_i45049_4_, final int p_i45049_5_, final int p_i45049_6_, final int p_i45049_7_) {
        ...
        this.field_148196_n = new ServerListEntryLanScan();
