...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void initGui() {
        ...
        final GuiButton var6 = new GuiButton(201, this.width / 2 + 5, this.height / 6 + 168, 150, 20, I18n.format("options.stream.ingestSelection", new Object[0]));
    ...
    protected void actionPerformed(final GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id < 100 && p_146284_1_ instanceof GuiOptionButton) {
                final GameSettings.Options var2 = ((GuiOptionButton)p_146284_1_).func_146136_c();
