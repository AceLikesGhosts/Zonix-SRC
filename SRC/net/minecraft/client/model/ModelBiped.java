...
public class ModelBiped extends ModelBase
{
    ...
    public ModelBiped(final float p_i1149_1_, final float p_i1149_2_, final int p_i1149_3_, final int p_i1149_4_) {
        ...
        (this.bipedCloak = new ModelRenderer(this, 0, 0)).addBox(-5.0f, 0.0f, -1.0f, 10, 16, 1, p_i1149_1_);
        (this.bipedEars = new ModelRenderer(this, 24, 0)).addBox(-3.0f, -6.0f, -1.0f, 6, 6, 1, p_i1149_1_);
