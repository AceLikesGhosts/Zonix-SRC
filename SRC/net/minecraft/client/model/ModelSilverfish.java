...
public class ModelSilverfish extends ModelBase
{
    ...
    public ModelSilverfish() {
        ...
        for (int var2 = 0; var2 < this.silverfishBodyParts.length; ++var2) {
            ...
            this.silverfishBodyParts[var2].setRotationPoint(0.0f, (float)(24 - ModelSilverfish.silverfishBoxLength[var2][1]), var1);
    ...
    public void setRotationAngles(final float p_78087_1_, final float p_78087_2_, final float p_78087_3_, final float p_78087_4_, final float p_78087_5_, final float p_78087_6_, final Entity p_78087_7_) {
        for (int var8 = 0; var8 < this.silverfishBodyParts.length; ++var8) {
            this.silverfishBodyParts[var8].rotateAngleY = MathHelper.cos(p_78087_3_ * 0.9f + var8 * 0.15f * 3.1415927f) * 3.1415927f * 0.05f * (1 + Math.abs(var8 - 2));
            this.silverfishBodyParts[var8].rotationPointX = MathHelper.sin(p_78087_3_ * 0.9f + var8 * 0.15f * 3.1415927f) * 3.1415927f * 0.2f * Math.abs(var8 - 2);
        }
    ...
    static {
        ...
        silverfishTexturePositions = new int[][] { { 0, 0 }, { 0, 4 }, { 0, 9 }, { 0, 16 }, { 0, 22 }, { 11, 0 }, { 13, 4 } };
    }
}
