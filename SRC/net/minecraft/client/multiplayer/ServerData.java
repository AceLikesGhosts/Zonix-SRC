...
public class ServerData
{
    ...
    public ServerData(final String p_i46395_1_, final String p_i46395_2_, final boolean p_i46395_3_) {
        this(p_i46395_1_, p_i46395_2_);
        this.field_152588_l = p_i46395_3_;
    }
    
    public ServerData(final String p_i46395_1_, final String p_i46395_2_, final int p_i46395_3_) {
        this(p_i46395_1_, p_i46395_2_);
    ...
    public void func_152584_a(final ServerResourceMode p_152584_1_) {
        this.field_152587_j = p_152584_1_;
    }
    
    public static ServerData getServerDataFromNBTCompound(final NBTTagCompound p_78837_0_) {
        final ServerData var1 = new ServerData(p_78837_0_.getString("name"), p_78837_0_.getString("ip"));
        ...
        if (p_78837_0_.func_150297_b("acceptTextures", 1)) {
            if (p_78837_0_.getBoolean("acceptTextures")) {
                var1.func_152584_a(ServerResourceMode.ENABLED);
            }
            else {
                var1.func_152584_a(ServerResourceMode.DISABLED);
            }
        }
        else {
            var1.func_152584_a(ServerResourceMode.PROMPT);
        }
        return var1;
    }
    ...
    public void func_147407_a(final String p_147407_1_) {
        this.field_147411_m = p_147407_1_;
    }
    
    public void func_152583_a(final ServerData p_152583_1_) {
