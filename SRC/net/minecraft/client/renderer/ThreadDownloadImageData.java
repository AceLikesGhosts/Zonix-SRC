...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    private static final AtomicInteger field_147643_d;
    ...
    public void func_147641_a(final BufferedImage p_147641_1_) {
    ...
    protected void func_152433_a() {
        (this.imageThread = new Thread("Texture Downloader #" + ThreadDownloadImageData.field_147643_d.incrementAndGet()) {
    ...
    static {
        ...
        field_147643_d = new AtomicInteger(0);
    }
}
