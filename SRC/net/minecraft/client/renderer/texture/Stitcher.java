...
public class Stitcher
{
    ...
    public void doStitch() {
        ...
        for (int var3 = var1.length, var4 = 0; var4 < var3; ++var4) {
            ...
            if (!this.allocateSlot(var5)) {
                final String var6 = String.format("Unable to fit: %s - size: %dx%d - Maybe try a lowerresolution resourcepack?", var5.getAtlasSprite().getIconName(), var5.getAtlasSprite().getIconWidth(), var5.getAtlasSprite().getIconHeight());
    ...
    private static int func_147969_b(final int p_147969_0_, final int p_147969_1_) {
    ...
    private boolean expandAndAllocateSlot(final Holder p_94311_1_) {
        ...
        if (MathHelper.roundUpToPowerOfTwo((var12 ? this.currentHeight : this.currentWidth) + var4) > (var12 ? this.maxHeight : this.maxWidth)) {
            return false;
        }
        Slot var15;
        if (var12) {
    ...
    public static class Holder implements Comparable
    {
        ...
        public Holder(final TextureAtlasSprite p_i45094_1_, final int p_i45094_2_) {
            ...
            this.rotated = (func_147969_b(this.height, p_i45094_2_) > func_147969_b(this.width, p_i45094_2_));
        }
        ...
        public int getWidth() {
            return this.rotated ? func_147969_b((int)(this.height * this.scaleFactor), this.mipmapLevelHolder) : func_147969_b((int)(this.width * this.scaleFactor), this.mipmapLevelHolder);
        }
        
        public int getHeight() {
            return this.rotated ? func_147969_b((int)(this.width * this.scaleFactor), this.mipmapLevelHolder) : func_147969_b((int)(this.height * this.scaleFactor), this.mipmapLevelHolder);
        }
    ...
    public static class Slot
    {
        ...
        public boolean addSlot(final Holder p_94182_1_) {
            ...
            if (this.subSlots == null) {
                (this.subSlots = new ArrayList(1)).add(new Slot(this.originX, this.originY, var2, var3));
