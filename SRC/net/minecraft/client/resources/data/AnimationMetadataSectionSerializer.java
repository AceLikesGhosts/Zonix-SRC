...
public class AnimationMetadataSectionSerializer extends BaseMetadataSectionSerializer implements JsonSerializer
{
    ...
    public AnimationMetadataSection deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
        ...
        final JsonObject var5 = JsonUtils.getJsonElementAsJsonObject(p_deserialize_1_, "metadata section");
        final int var6 = JsonUtils.getJsonObjectIntegerFieldValueOrDefault(var5, "frametime", 1);
        if (var6 != 1) {
            Validate.inclusiveBetween((Object)1, (Object)Integer.MAX_VALUE, (Comparable)var6, "Invalid default frame time", new Object[0]);
        }
        if (var5.has("frames")) {
            try {
        ...
        if (var12 != -1) {
            Validate.inclusiveBetween((Object)1, (Object)Integer.MAX_VALUE, (Comparable)var12, "Invalid width", new Object[0]);
        }
        if (var8 != -1) {
            Validate.inclusiveBetween((Object)1, (Object)Integer.MAX_VALUE, (Comparable)var8, "Invalid height", new Object[0]);
        }
    ...
    private AnimationFrame parseAnimationFrame(final int p_110492_1_, final JsonElement p_110492_2_) {
        ...
        if (p_110492_2_.isJsonObject()) {
            final JsonObject var3 = JsonUtils.getJsonElementAsJsonObject(p_110492_2_, "frames[" + p_110492_1_ + "]");
            final int var4 = JsonUtils.getJsonObjectIntegerFieldValueOrDefault(var3, "time", -1);
            if (var3.has("time")) {
                Validate.inclusiveBetween((Object)1, (Object)Integer.MAX_VALUE, (Comparable)var4, "Invalid frame time", new Object[0]);
            }
            final int var5 = JsonUtils.getJsonObjectIntegerFieldValue(var3, "index");
            Validate.inclusiveBetween((Object)0, (Object)Integer.MAX_VALUE, (Comparable)var5, "Invalid frame index", new Object[0]);
