    ...
    public FontMetadataSection deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
        ...
        if (var4.has("characters")) {
            ...
            if (var11.has("default")) {
                ...
                Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var8, "Invalid default width", new Object[0]);
                var9 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "spacing", var9);
                Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var9, "Invalid default spacing", new Object[0]);
                var10 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "left", var9);
                Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var10, "Invalid default left", new Object[0]);
            }
            for (int var13 = 0; var13 < 256; ++var13) {
                ...
                float var17 = var10;
                if (var14 != null) {
                    final JsonObject var18 = JsonUtils.getJsonElementAsJsonObject(var14, "characters[" + var13 + "]");
                    var15 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var18, "width", var8);
                    Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var15, "Invalid width", new Object[0]);
                    var16 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var18, "spacing", var9);
                    Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var16, "Invalid spacing", new Object[0]);
                    var17 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var18, "left", var10);
                    Validate.inclusiveBetween((Object)0.0f, (Object)Float.MAX_VALUE, (Comparable)var17, "Invalid left", new Object[0]);
                }
                var5[var13] = var15;
                var6[var13] = var16;
                var7[var13] = var17;
