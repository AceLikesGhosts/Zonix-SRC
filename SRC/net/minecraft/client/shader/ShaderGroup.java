...
public class ShaderGroup
{
    ...
    public void func_152765_a(final TextureManager p_152765_1_, final ResourceLocation p_152765_2_) throws JsonException {
    ...
    private void initTarget(final JsonElement p_148027_1_) throws JsonException {
        if (JsonUtils.jsonElementTypeIsString(p_148027_1_)) {
            ...
            final JsonObject var2 = JsonUtils.getJsonElementAsJsonObject(p_148027_1_, "target");
    ...
    private void func_152764_a(final TextureManager p_152764_1_, final JsonElement p_152764_2_) throws JsonException {
        final JsonObject var3 = JsonUtils.getJsonElementAsJsonObject(p_152764_2_, "pass");
        ...
        if (var10 != null) {
            ...
            for (final JsonElement var13 : var10) {
                try {
                    final JsonObject var14 = JsonUtils.getJsonElementAsJsonObject(var13, "auxtarget");
    ...
    private void initUniform(final JsonElement p_148028_1_) throws JsonException {
        final JsonObject var2 = JsonUtils.getJsonElementAsJsonObject(p_148028_1_, "uniform");
        final String var3 = JsonUtils.getJsonObjectStringFieldValue(var2, "name");
        final ShaderUniform var4 = this.listShaders.get(this.listShaders.size() - 1).getShaderManager().func_147991_a(var3);
        if (var4 == null) {
