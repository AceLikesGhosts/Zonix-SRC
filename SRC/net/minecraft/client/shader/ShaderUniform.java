...
public class ShaderUniform
{
    ...
    public ShaderUniform(final String p_i45092_1_, final int p_i45092_2_, final int p_i45092_3_, final ShaderManager p_i45092_4_) {
    ...
    public static int func_148085_a(final String p_148085_0_) {
        byte var1 = -1;
    ...
    public void func_148084_b(final int p_148084_1_) {
    ...
    public void func_148090_a(final float p_148090_1_) {
        this.field_148098_f.position(0);
        this.field_148098_f.put(0, p_148090_1_);
        this.func_148096_h();
    }
    
    public void func_148087_a(final float p_148087_1_, final float p_148087_2_) {
        this.field_148098_f.position(0);
    ...
    public void func_148095_a(final float p_148095_1_, final float p_148095_2_, final float p_148095_3_) {
        this.field_148098_f.position(0);
    ...
    public void func_148081_a(final float p_148081_1_, final float p_148081_2_, final float p_148081_3_, final float p_148081_4_) {
        this.field_148098_f.position(0);
    ...
    public void func_148083_a(final int p_148083_1_, final int p_148083_2_, final int p_148083_3_, final int p_148083_4_) {
    ...
    public void func_148097_a(final float[] p_148097_1_) {
        if (p_148097_1_.length < this.field_148103_c) {
            ShaderUniform.logger.warn("Uniform.set called with a too-small value array (expected " + this.field_148103_c + ", got " + p_148097_1_.length + "). Ignoring.");
        }
        else {
            this.field_148098_f.position(0);
    ...
    public void func_148094_a(final float p_148094_1_, final float p_148094_2_, final float p_148094_3_, final float p_148094_4_, final float p_148094_5_, final float p_148094_6_, final float p_148094_7_, final float p_148094_8_, final float p_148094_9_, final float p_148094_10_, final float p_148094_11_, final float p_148094_12_, final float p_148094_13_, final float p_148094_14_, final float p_148094_15_, final float p_148094_16_) {
        this.field_148098_f.position(0);
    ...
    public void func_148088_a(final Matrix4f p_148088_1_) {
    ...
    public void func_148093_b() {
        ...
        if (this.field_148100_d <= 3) {
            ...
            if (this.field_148100_d > 10) {
                ShaderUniform.logger.warn("Uniform.upload called, but type value (" + this.field_148100_d + ") is not a valid type. Ignoring.");
                return;
            }
            this.func_148082_k();
        }
    ...
    private void func_148091_i() {
        switch (this.field_148100_d) {
            ...
            default: {
                ShaderUniform.logger.warn("Uniform.upload called, but count value (" + this.field_148103_c + ") is  not in the range of 1 to 4. Ignoring.");
                break;
            }
        }
    }
