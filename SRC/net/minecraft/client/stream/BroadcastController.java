...
{
    private static final Logger field_152861_B;
    ...
    protected BroadcastState field_152879_o;
    ...
    public void getIngestServersCallback(final ErrorCode p_getIngestServersCallback_1_, final IngestList p_getIngestServersCallback_2_) {
        if (ErrorCode.succeeded(p_getIngestServersCallback_1_)) {
            ...
            this.func_152827_a(BroadcastState.ReceivedIngestServers);
            try {
                if (this.field_152867_c != null) {
            ...
            this.func_152820_d(String.format("IngestListCallback got failure: %s", var5));
    ...
    public void getStreamInfoCallback(final ErrorCode p_getStreamInfoCallback_1_, final StreamInfo p_getStreamInfoCallback_2_) {
        if (ErrorCode.succeeded(p_getStreamInfoCallback_1_)) {
            ...
            this.func_152832_e(String.format("StreamInfoDoneCallback got failure: %s", var5));
        }
    }
    ...
    public void startCallback(final ErrorCode p_startCallback_1_) {
        if (ErrorCode.succeeded(p_startCallback_1_)) {
            ...
            final String var4 = ErrorCode.getString(p_startCallback_1_);
            this.field_152867_c.func_152892_c(p_startCallback_1_);
            this.func_152820_d(String.format("startCallback got failure: %s", var4));
        }
    }
    ...
    public void stopCallback(final ErrorCode p_stopCallback_1_) {
        if (ErrorCode.succeeded(p_stopCallback_1_)) {
            ...
            this.func_152820_d(String.format("stopCallback got failure: %s", var4));
        }
    }
    ...
    public BroadcastController() {
        ...
        this.field_152874_j = new ArrayList();
        this.field_152875_k = new ArrayList();
        this.field_152876_l = false;
        this.field_152877_m = false;
        this.field_152878_n = false;
        this.field_152879_o = BroadcastState.Uninitialized;
    ...
    public boolean func_152817_A() {
        ...
        this.field_152873_i.setStreamCallbacks((IStreamCallbacks)this);
        if (!this.func_152853_a(var1)) {
    ...
    public IngestServerTester func_152838_J() {
        ...
        (this.field_152860_A = new IngestServerTester(this.field_152873_i, this.field_152883_s)).func_153033_i();
    ...
    protected void func_152820_d(final String p_152820_1_) {
        ...
        BroadcastController.field_152861_B.error(TwitchStream.field_152949_a, "[Broadcast controller] {}", new Object[] { p_152820_1_ });
    }
    ...
    protected void func_152832_e(final String p_152832_1_) {
        ...
        BroadcastController.field_152861_B.warn(TwitchStream.field_152949_a, "[Broadcast controller] {}", new Object[] { p_152832_1_ });
    }
    ...
    static {
        field_152861_B = LogManager.getLogger();
    ...
    {
        static final int[] field_152815_a;
        private static final String __OBFID = "CL_00001821";
        
        static {
            field_152815_a = new int[BroadcastState.values().length];
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Authenticated.ordinal()] = 1;
            }
            catch (NoSuchFieldError noSuchFieldError) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.LoggedIn.ordinal()] = 2;
            }
            catch (NoSuchFieldError noSuchFieldError2) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.ReceivedIngestServers.ordinal()] = 3;
            }
            catch (NoSuchFieldError noSuchFieldError3) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Starting.ordinal()] = 4;
            }
            catch (NoSuchFieldError noSuchFieldError4) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Stopping.ordinal()] = 5;
            }
            catch (NoSuchFieldError noSuchFieldError5) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.FindingIngestServer.ordinal()] = 6;
            }
            catch (NoSuchFieldError noSuchFieldError6) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Authenticating.ordinal()] = 7;
            }
            catch (NoSuchFieldError noSuchFieldError7) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Initialized.ordinal()] = 8;
            }
            catch (NoSuchFieldError noSuchFieldError8) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Uninitialized.ordinal()] = 9;
            }
            catch (NoSuchFieldError noSuchFieldError9) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.IngestTesting.ordinal()] = 10;
            }
            catch (NoSuchFieldError noSuchFieldError10) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Paused.ordinal()] = 11;
            }
            catch (NoSuchFieldError noSuchFieldError11) {}
            try {
                SwitchBroadcastState.field_152815_a[BroadcastState.Broadcasting.ordinal()] = 12;
            }
