...
public class IngestServerTester implements IStatCallbacks, IStreamCallbacks
{
    ...
    public void statCallback(final StatType p_statCallback_1_, final long p_statCallback_2_) {
        switch (SwitchStatType.field_153026_a[p_statCallback_1_.ordinal()]) {
            case 1: {
        ...
        if (!this.func_153032_e() && this.field_153047_e != IngestTestState.Uninitalized && !this.field_153067_y) {
            ...
            switch (SwitchStatType.field_153027_b[this.field_153047_e.ordinal()]) {
                ...
                case 2: {
                    ...
                    if (this.field_153067_y || this.func_153037_m() < this.field_153049_g) {
                        break;
                    }
                    this.field_153054_l = 0L;
                    this.field_153061_s = false;
    ...
    public enum IngestTestState
    {
        ...
        static {
            $VALUES = new IngestTestState[] { IngestTestState.Uninitalized, IngestTestState.Starting, IngestTestState.ConnectingToServer, IngestTestState.TestingServer, IngestTestState.DoneTestingServer, IngestTestState.Finished, IngestTestState.Cancelled, IngestTestState.Failed };
        }
    }
    ...
    static final class SwitchStatType
    {
        ...
        static {
            field_153027_b = new int[IngestTestState.values().length];
            try {
                SwitchStatType.field_153027_b[IngestTestState.Starting.ordinal()] = 1;
            }
            catch (NoSuchFieldError noSuchFieldError) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.DoneTestingServer.ordinal()] = 2;
            }
            catch (NoSuchFieldError noSuchFieldError2) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.ConnectingToServer.ordinal()] = 3;
            }
            catch (NoSuchFieldError noSuchFieldError3) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.TestingServer.ordinal()] = 4;
            }
            catch (NoSuchFieldError noSuchFieldError4) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.Uninitalized.ordinal()] = 5;
            }
            catch (NoSuchFieldError noSuchFieldError5) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.Finished.ordinal()] = 6;
            }
            catch (NoSuchFieldError noSuchFieldError6) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.Cancelled.ordinal()] = 7;
            }
            catch (NoSuchFieldError noSuchFieldError7) {}
            try {
                SwitchStatType.field_153027_b[IngestTestState.Failed.ordinal()] = 8;
            }
            catch (NoSuchFieldError noSuchFieldError8) {}
            field_153026_a = new int[StatType.values().length];
            try {
                SwitchStatType.field_153026_a[StatType.TTV_ST_RTMPSTATE.ordinal()] = 1;
            }
            catch (NoSuchFieldError noSuchFieldError9) {}
            try {
                SwitchStatType.field_153026_a[StatType.TTV_ST_RTMPDATASENT.ordinal()] = 2;
            }
