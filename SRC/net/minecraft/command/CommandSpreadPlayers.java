...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    public void processCommand(final ICommandSender p_71515_1_, final String[] p_71515_2_) {
        ...
        final byte var3 = 0;
        int var4 = var3 + 1;
        final double var5 = CommandBase.func_110666_a(p_71515_1_, Double.NaN, p_71515_2_[var3]);
        final double var6 = CommandBase.func_110666_a(p_71515_1_, Double.NaN, p_71515_2_[var4++]);
        final double var7 = CommandBase.parseDoubleWithMin(p_71515_1_, p_71515_2_[var4++], 0.0);
        final double var8 = CommandBase.parseDoubleWithMin(p_71515_1_, p_71515_2_[var4++], var7 + 1.0);
        final boolean var9 = CommandBase.parseBoolean(p_71515_1_, p_71515_2_[var4++]);
        final ArrayList var10 = Lists.newArrayList();
        while (var4 < p_71515_2_.length) {
            final String var11 = p_71515_2_[var4++];
            if (PlayerSelector.hasArguments(var11)) {
                final EntityPlayerMP[] var12 = PlayerSelector.matchPlayers(p_71515_1_, var11);
                if (var12 == null || var12.length == 0) {
                    throw new PlayerNotFoundException();
                }
                Collections.addAll(var10, var12);
            }
            else {
                final EntityPlayerMP var13 = MinecraftServer.getServer().getConfigurationManager().func_152612_a(var11);
                if (var13 == null) {
                    throw new PlayerNotFoundException();
                }
                var10.add(var13);
        ...
        p_71515_1_.addChatMessage(new ChatComponentTranslation("commands.spreadplayers.spreading." + (var9 ? "teams" : "players"), new Object[] { var10.size(), var8, var5, var6, var7 }));
        this.func_110669_a(p_71515_1_, var10, new Position(var5, var6), var7, var8, var10.get(0).worldObj, var9);
    }
    
    private void func_110669_a(final ICommandSender p_110669_1_, final List p_110669_2_, final Position p_110669_3_, final double p_110669_4_, final double p_110669_6_, final World p_110669_8_, final boolean p_110669_9_) {
        ...
        final int var16 = this.func_110668_a(p_110669_3_, p_110669_4_, p_110669_8_, var10, var11, var12, var13, var14, var15, p_110669_9_);
        final double var17 = this.func_110671_a(p_110669_2_, p_110669_8_, var15, p_110669_9_);
        CommandBase.func_152373_a(p_110669_1_, this, "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), var15.length, p_110669_3_.field_111101_a, p_110669_3_.field_111100_b);
        if (var15.length > 1) {
    ...
    private int func_110667_a(final List p_110667_1_) {
        ...
        for (final EntityLivingBase var4 : p_110667_1_) {
    ...
    private int func_110668_a(final Position p_110668_1_, final double p_110668_2_, final World p_110668_4_, final Random p_110668_5_, final double p_110668_6_, final double p_110668_8_, final double p_110668_10_, final double p_110668_12_, final Position[] p_110668_14_, final boolean p_110668_15_) {
        boolean var16 = true;
        ...
        for (var18 = 0; var18 < 10000 && var16; ++var18) {
            ...
            if (!var16) {
                ...
                for (int var28 = p_110668_14_.length, var21 = 0; var21 < var28; ++var21) {
                    ...
                    if (!var22.func_111098_b(p_110668_4_)) {
    ...
    private double func_110671_a(final List p_110671_1_, final World p_110671_2_, final Position[] p_110671_3_, final boolean p_110671_4_) {
        double var5 = 0.0;
        int var6 = 0;
        final HashMap var7 = Maps.newHashMap();
        for (int var8 = 0; var8 < p_110671_1_.size(); ++var8) {
            final EntityLivingBase var9 = p_110671_1_.get(var8);
            Position var11;
            if (p_110671_4_) {
                final Team var10 = (var9 instanceof EntityPlayer) ? var9.getTeam() : null;
            ...
            var9.setPositionAndUpdate(MathHelper.floor_double(var11.field_111101_a) + 0.5f, var11.func_111092_a(p_110671_2_), MathHelper.floor_double(var11.field_111100_b) + 0.5);
    ...
    static class Position
    {
        ...
        public int func_111092_a(final World p_111092_1_) {
            final int var2 = MathHelper.floor_double(this.field_111101_a);
            final int var3 = MathHelper.floor_double(this.field_111100_b);
        ...
        public boolean func_111098_b(final World p_111098_1_) {
            final int var2 = MathHelper.floor_double(this.field_111101_a);
            final int var3 = MathHelper.floor_double(this.field_111100_b);
            ...
            final Material var5 = p_111098_1_.getBlock(var2, var4, var3).getMaterial();
