...
public class CrashReportCategory
{
    ...
    public CrashReportCategory(final CrashReport p_i1353_1_, final String p_i1353_2_) {
    ...
    public static String func_85074_a(final double p_85074_0_, final double p_85074_2_, final double p_85074_4_) {
        return String.format("%.2f,%.2f,%.2f - %s", p_85074_0_, p_85074_2_, p_85074_4_, getLocationInfo(MathHelper.floor_double(p_85074_0_), MathHelper.floor_double(p_85074_2_), MathHelper.floor_double(p_85074_4_)));
    }
    
    public static String getLocationInfo(final int p_85071_0_, final int p_85071_1_, final int p_85071_2_) {
        final StringBuilder var3 = new StringBuilder();
        try {
            var3.append(String.format("World: (%d,%d,%d)", p_85071_0_, p_85071_1_, p_85071_2_));
        }
        ...
        var3.append(", ");
        try {
            final int var4 = p_85071_0_ >> 4;
            final int var5 = p_85071_2_ >> 4;
            final int var6 = p_85071_0_ & 0xF;
            final int var7 = p_85071_1_ >> 4;
            final int var8 = p_85071_2_ & 0xF;
        ...
        var3.append(", ");
        try {
            final int var4 = p_85071_0_ >> 9;
            final int var5 = p_85071_2_ >> 9;
    ...
    public void addCrashSectionCallable(final String p_71500_1_, final Callable p_71500_2_) {
        try {
    ...
    public void addCrashSection(final String p_71507_1_, final Object p_71507_2_) {
        this.field_85077_c.add(new Entry(p_71507_1_, p_71507_2_));
    }
    
    public void addCrashSectionThrowable(final String p_71499_1_, final Throwable p_71499_2_) {
        this.addCrashSection(p_71499_1_, p_71499_2_);
    }
    
    public int getPrunedStackTrace(final int p_85073_1_) {
        final StackTraceElement[] var2 = Thread.currentThread().getStackTrace();
        if (var2.length <= 0) {
            return 0;
        }
        System.arraycopy(var2, 3 + p_85073_1_, this.stackTrace = new StackTraceElement[var2.length - 3 - p_85073_1_], 0, this.stackTrace.length);
        return this.stackTrace.length;
    }
    
    public boolean firstTwoElementsOfStackTraceMatch(final StackTraceElement p_85069_1_, final StackTraceElement p_85069_2_) {
        ...
        if (p_85069_2_ != null && !this.stackTrace[1].equals(p_85069_2_)) {
            return false;
        }
    ...
    public void trimStackTraceEntriesFromBottom(final int p_85070_1_) {
        final StackTraceElement[] var2 = new StackTraceElement[this.stackTrace.length - p_85070_1_];
        System.arraycopy(this.stackTrace, 0, var2, 0, var2.length);
        this.stackTrace = var2;
    }
    
    public void appendToStringBuilder(final StringBuilder p_85072_1_) {
        p_85072_1_.append("-- ").append(this.field_85076_b).append(" --\n");
        p_85072_1_.append("Details:");
        for (final Entry var3 : this.field_85077_c) {
            p_85072_1_.append("\n\t");
        ...
        if (this.stackTrace != null && this.stackTrace.length > 0) {
            ...
            for (final StackTraceElement var7 : this.stackTrace) {
                p_85072_1_.append("\n\tat ");
                p_85072_1_.append(var7.toString());
            }
        }
    }
    ...
    public static void func_147153_a(final CrashReportCategory p_147153_0_, final int p_147153_1_, final int p_147153_2_, final int p_147153_3_, final Block p_147153_4_, final int p_147153_5_) {
        ...
        p_147153_0_.addCrashSectionCallable("Block type", new Callable() {
            ...
            public String call() {
                try {
                    return String.format("ID #%d (%s // %s)", var6, p_147153_4_.getUnlocalizedName(), p_147153_4_.getClass().getCanonicalName());
                }
        ...
        p_147153_0_.addCrashSectionCallable("Block data value", new Callable() {
            ...
            public String call() {
                ...
                final String var1 = String.format("%4s", Integer.toBinaryString(p_147153_5_)).replace(" ", "0");
                return String.format("%1$d / 0x%1$X / 0b%2$s", p_147153_5_, var1);
            }
        });
    ...
    static class Entry
    {
        ...
        public Entry(final String p_i1352_1_, final Object p_i1352_2_) {
            this.field_85092_a = p_i1352_1_;
            if (p_i1352_2_ == null) {
                this.field_85091_b = "~~NULL~~";
            }
            else if (p_i1352_2_ instanceof Throwable) {
                final Throwable var3 = (Throwable)p_i1352_2_;
