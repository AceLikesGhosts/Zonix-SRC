...
public abstract class CreativeTabs
{
    ...
    public CreativeTabs(final int p_i1853_1_, final String p_i1853_2_) {
        this.backgroundImageName = "items.png";
        this.hasScrollbar = true;
        this.drawTitle = true;
        this.tabIndex = p_i1853_1_;
        this.tabLabel = p_i1853_2_;
        CreativeTabs.creativeTabArray[p_i1853_1_] = this;
    }
    ...
    public CreativeTabs setBackgroundImageName(final String p_78025_1_) {
    ...
    public CreativeTabs func_111229_a(final EnumEnchantmentType... p_111229_1_) {
        this.field_111230_s = p_111229_1_;
        return this;
    }
    
    public boolean func_111226_a(final EnumEnchantmentType p_111226_1_) {
        if (this.field_111230_s == null) {
            return false;
        }
        for (final EnumEnchantmentType var5 : this.field_111230_s) {
            if (var5 == p_111226_1_) {
                return true;
            }
        }
