...
public class EnchantmentHelper
{
    ...
    public static void setEnchantments(final Map p_82782_0_, final ItemStack p_82782_1_) {
        ...
        for (final int var4 : p_82782_0_.keySet()) {
            ...
            var5.setShort("lvl", (short)(int)p_82782_0_.get(var4));
            var2.appendTag(var5);
            if (p_82782_1_.getItem() == Items.enchanted_book) {
                Items.enchanted_book.addEnchantment(p_82782_1_, new EnchantmentData(var4, p_82782_0_.get(var4)));
            }
        }
        if (var2.tagCount() > 0) {
            if (p_82782_1_.getItem() != Items.enchanted_book) {
    ...
    public static float getEnchantmentModifierLiving(final EntityLivingBase p_77512_0_, final EntityLivingBase p_77512_1_) {
    ...
    public static void func_151384_a(final EntityLivingBase p_151384_0_, final Entity p_151384_1_) {
        ...
        applyEnchantmentModifierArray(EnchantmentHelper.field_151388_d, p_151384_0_.getLastActiveItems());
    ...
    public static void func_151385_b(final EntityLivingBase p_151385_0_, final Entity p_151385_1_) {
        ...
        applyEnchantmentModifierArray(EnchantmentHelper.field_151389_e, p_151385_0_.getLastActiveItems());
        if (p_151385_0_ instanceof EntityPlayer) {
            applyEnchantmentModifier(EnchantmentHelper.field_151389_e, p_151385_0_.getHeldItem());
        }
    }
    
    public static int getKnockbackModifier(final EntityLivingBase p_77507_0_, final EntityLivingBase p_77507_1_) {
    ...
    public static ItemStack func_92099_a(final Enchantment p_92099_0_, final EntityLivingBase p_92099_1_) {
        for (final ItemStack var5 : p_92099_1_.getLastActiveItems()) {
