...
public class EnchantmentProtection extends Enchantment
{
    ...
    public EnchantmentProtection(final int p_i1936_1_, final int p_i1936_2_, final int p_i1936_3_) {
    ...
    public static int getFireTimeForEntity(final Entity p_92093_0_, int p_92093_1_) {
        final int var2 = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.fireProtection.effectId, p_92093_0_.getLastActiveItems());
        if (var2 > 0) {
    ...
    public static double func_92092_a(final Entity p_92092_0_, double p_92092_1_) {
        final int var3 = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.blastProtection.effectId, p_92092_0_.getLastActiveItems());
        if (var3 > 0) {
