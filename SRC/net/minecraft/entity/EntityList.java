...
public class EntityList
{
    ...
    private static void addMapping(final Class p_75618_0_, final String p_75618_1_, final int p_75618_2_) {
        ...
        EntityList.stringToIDMapping.put(p_75618_1_, p_75618_2_);
    }
    ...
    public static Entity createEntityByName(final String p_75620_0_, final World p_75620_1_) {
        Entity var2 = null;
        try {
            final Class var3 = EntityList.stringToClassMapping.get(p_75620_0_);
            if (var3 != null) {
                var2 = var3.getConstructor(World.class).newInstance(p_75620_1_);
            }
        }
    ...
    public static Entity createEntityFromNBT(final NBTTagCompound p_75615_0_, final World p_75615_1_) {
        Entity var2 = null;
        ...
        try {
            ...
            if (var3 != null) {
                var2 = var3.getConstructor(World.class).newInstance(p_75615_1_);
            }
        }
        catch (Exception var4) {
            var4.printStackTrace();
    ...
    public static Entity createEntityByID(final int p_75616_0_, final World p_75616_1_) {
        Entity var2 = null;
        try {
            final Class var3 = getClassFromID(p_75616_0_);
            if (var3 != null) {
                var2 = var3.getConstructor(World.class).newInstance(p_75616_1_);
            }
        }
        catch (Exception var4) {
            var4.printStackTrace();
    ...
    public static int getEntityID(final Entity p_75619_0_) {
        final Class var1 = p_75619_0_.getClass();
    ...
    public static String getStringFromID(final int p_75617_0_) {
        final Class var1 = getClassFromID(p_75617_0_);
    ...
    public static Set func_151515_b() {
        return Collections.unmodifiableSet(EntityList.stringToIDMapping.keySet());
    }
