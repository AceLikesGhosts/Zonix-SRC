...
public class SharedMonsterAttributes
{
    ...
    static {
        ...
        maxHealth = new RangedAttribute("generic.maxHealth", 20.0, 0.0, Double.MAX_VALUE).setDescription("Max Health").setShouldWatch(true);
        followRange = new RangedAttribute("generic.followRange", 32.0, 0.0, 2048.0).setDescription("Follow Range");
        knockbackResistance = new RangedAttribute("generic.knockbackResistance", 0.0, 0.0, 1.0).setDescription("Knockback Resistance");
        movementSpeed = new RangedAttribute("generic.movementSpeed", 0.699999988079071, 0.0, Double.MAX_VALUE).setDescription("Movement Speed").setShouldWatch(true);
        attackDamage = new RangedAttribute("generic.attackDamage", 2.0, 0.0, Double.MAX_VALUE);
    }
}
