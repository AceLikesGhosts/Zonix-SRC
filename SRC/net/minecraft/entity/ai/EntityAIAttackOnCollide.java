...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    public boolean continueExecuting() {
        final EntityLivingBase var1 = this.attacker.getAttackTarget();
        return var1 != null && var1.isEntityAlive() && (this.longMemory ? this.attacker.isWithinHomeDistance(MathHelper.floor_double(var1.posX), MathHelper.floor_double(var1.posY), MathHelper.floor_double(var1.posZ)) : (!this.attacker.getNavigator().noPath()));
    }
    ...
    public void updateTask() {
        ...
        final double var2 = this.attacker.getDistanceSq(var1.posX, var1.boundingBox.minY, var1.posZ);
        final double var3 = this.attacker.width * 2.0f * this.attacker.width * 2.0f + var1.width;
        --this.field_75445_i;
        ...
        if (var2 <= var3 && this.attackTick <= 20) {
            this.attackTick = 20;
