...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask() {
        ...
        final PathPoint var19 = new PathPoint(MathHelper.floor_float(this.thisEntity.width + 1.0f), MathHelper.floor_float(this.thisEntity.height + var1.height + 1.0f), MathHelper.floor_float(this.thisEntity.width + 1.0f));
        if (var4 != var17 || var6 != var18) {
            final Block var20 = this.thisEntity.worldObj.getBlock(var4, var5, var6);
            final boolean var21 = !this.func_151498_a(var20) && (var20.getMaterial() != Material.air || !this.func_151498_a(this.thisEntity.worldObj.getBlock(var4, var5 - 1, var6)));
    ...
    private boolean func_151498_a(final Block p_151498_1_) {
