...
public class ModifiableAttributeInstance implements IAttributeInstance
{
    ...
    public void removeAllModifiers() {
        ...
        if (var1 != null) {
            final ArrayList var2 = new ArrayList(var1);
    ...
    private double computeValue() {
        ...
        for (final AttributeModifier var3 : this.getModifiersByOperation(0)) {
            var1 += var3.getAmount();
        }
        double var4 = var1;
        for (final AttributeModifier var6 : this.getModifiersByOperation(1)) {
            var4 += var1 * var6.getAmount();
        }
        for (final AttributeModifier var6 : this.getModifiersByOperation(2)) {
