...
public class RangedAttribute extends BaseAttribute
{
    ...
    public RangedAttribute(final String p_i1609_1_, final double p_i1609_2_, final double p_i1609_4_, final double p_i1609_6_) {
        ...
        if (p_i1609_2_ < p_i1609_4_) {
            throw new IllegalArgumentException("Default value cannot be lower than minimum value!");
        }
        if (p_i1609_2_ > p_i1609_6_) {
