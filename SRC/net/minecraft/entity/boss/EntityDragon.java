...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public EntityDragon(final World p_i1700_1_) {
        super(p_i1700_1_);
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0f) {
            ...
            if (this.worldObj.isClient) {
                ...
                final Vec3 var16 = Vec3.createVectorHelper(this.targetX - this.posX, this.targetY - this.posY, this.targetZ - this.posZ).normalize();
                final Vec3 var17 = Vec3.createVectorHelper(MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f), this.motionY, -MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f)).normalize();
                ...
                final Vec3 var23 = Vec3.createVectorHelper(this.motionX, this.motionY, this.motionZ).normalize();
        ...
        for (int var10 = var2; var10 <= var5; ++var10) {
            for (int var11 = var3; var11 <= var6; ++var11) {
                for (int var12 = var4; var12 <= var7; ++var12) {
                    final Block var13 = this.worldObj.getBlock(var10, var11, var12);
    ...
    private void createEnderPortal(final int p_70975_1_, final int p_70975_2_) {
        final byte var3 = 64;
        ...
        for (int var5 = var3 - 1; var5 <= var3 + 32; ++var5) {
            for (int var6 = p_70975_1_ - var4; var6 <= p_70975_1_ + var4; ++var6) {
                for (int var7 = p_70975_2_ - var4; var7 <= p_70975_2_ + var4; ++var7) {
                    ...
                    final double var9 = var7 - p_70975_2_;
