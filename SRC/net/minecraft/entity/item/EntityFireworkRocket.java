...
public class EntityFireworkRocket extends Entity
{
    ...
    public EntityFireworkRocket(final World p_i1762_1_) {
        super(p_i1762_1_);
    ...
    public EntityFireworkRocket(final World p_i1763_1_, final double p_i1763_2_, final double p_i1763_4_, final double p_i1763_6_, final ItemStack p_i1763_8_) {
        super(p_i1763_1_);
        this.fireworkAge = 0;
        this.setSize(0.25f, 0.25f);
