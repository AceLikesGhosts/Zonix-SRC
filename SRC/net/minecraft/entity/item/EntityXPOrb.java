...
public class EntityXPOrb extends Entity
{
    ...
    public EntityXPOrb(final World p_i1585_1_, final double p_i1585_2_, final double p_i1585_4_, final double p_i1585_6_, final int p_i1585_8_) {
        super(p_i1585_1_);
        this.xpOrbHealth = 5;
    ...
    public EntityXPOrb(final World p_i1586_1_) {
        super(p_i1586_1_);
        this.xpOrbHealth = 5;
    ...
    public void onUpdate() {
        ...
        float var7 = 0.98f;
        if (this.onGround) {
            var7 = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ)).slipperiness * 0.98f;
        }
        this.motionX *= var7;
    ...
    public boolean attackEntityFrom(final DamageSource p_70097_1_, final float p_70097_2_) {
        ...
        this.xpOrbHealth -= (int)p_70097_2_;
    ...
    public void onCollideWithPlayer(final EntityPlayer p_70100_1_) {
        if (!this.worldObj.isClient && this.field_70532_c == 0 && p_70100_1_.xpCooldown == 0) {
