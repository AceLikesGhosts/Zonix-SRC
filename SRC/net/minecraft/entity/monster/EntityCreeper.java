...
public class EntityCreeper extends EntityMob
{
    ...
    public EntityCreeper(final World p_i1733_1_) {
        super(p_i1733_1_);
        this.fuseTime = 30;
    ...
    protected void fall(final float p_70069_1_) {
        ...
        this.timeSinceIgnited += (int)(p_70069_1_ * 1.5f);
    ...
    public void readEntityFromNBT(final NBTTagCompound p_70037_1_) {
        ...
        this.dataWatcher.updateObject(17, (byte)(byte)(p_70037_1_.getBoolean("powered") ? 1 : 0));
