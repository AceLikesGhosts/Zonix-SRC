...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    public EntityGhast(final World p_i1735_1_) {
        super(p_i1735_1_);
    ...
    public boolean attackEntityFrom(final DamageSource p_70097_1_, final float p_70097_2_) {
        ...
        if ("fireball".equals(p_70097_1_.getDamageType()) && p_70097_1_.getEntity() instanceof EntityPlayer) {
    ...
    private boolean isCourseTraversable(final double p_70790_1_, final double p_70790_3_, final double p_70790_5_, final double p_70790_7_) {
        final double var9 = (this.waypointX - this.posX) / p_70790_7_;
        final double var10 = (this.waypointY - this.posY) / p_70790_7_;
        final double var11 = (this.waypointZ - this.posZ) / p_70790_7_;
        final AxisAlignedBB var12 = this.boundingBox.copy();
        for (int var13 = 1; var13 < p_70790_7_; ++var13) {
