...
public class EntitySilverfish extends EntityMob
{
    ...
    public EntitySilverfish(final World p_i1740_1_) {
        super(p_i1740_1_);
    ...
    protected void updateEntityActionState() {
        ...
        if (!this.worldObj.isClient) {
                            ...
                            for (int var7 = 0; !var4 && var7 <= 10 && var7 >= -10; var7 = ((var7 <= 0) ? (1 - var7) : (0 - var7))) {
                                if (this.worldObj.getBlock(var1 + var6, var2 + var5, var3 + var7) == Blocks.monster_egg) {
                                    if (!this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
                                        final int var8 = this.worldObj.getBlockMetadata(var1 + var6, var2 + var5, var3 + var7);
                                        final ImmutablePair var9 = BlockSilverfish.func_150197_b(var8);
                                        this.worldObj.setBlock(var1 + var6, var2 + var5, var3 + var7, (Block)var9.getLeft(), (int)var9.getRight(), 3);
                                    }
                                    else {
            ...
            if (this.entityToAttack == null && !this.hasPath()) {
                ...
                final int var3 = MathHelper.floor_double(this.posZ);
                final int var10 = this.rand.nextInt(6);
                final Block var11 = this.worldObj.getBlock(var1 + Facing.offsetsXForSide[var10], var2 + Facing.offsetsYForSide[var10], var3 + Facing.offsetsZForSide[var10]);
                final int var6 = this.worldObj.getBlockMetadata(var1 + Facing.offsetsXForSide[var10], var2 + Facing.offsetsYForSide[var10], var3 + Facing.offsetsZForSide[var10]);
