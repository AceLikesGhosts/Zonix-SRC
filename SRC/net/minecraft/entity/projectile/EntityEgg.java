...
public class EntityEgg extends EntityThrowable
{
    ...
    public EntityEgg(final World p_i1779_1_) {
        super(p_i1779_1_);
    }
    
    public EntityEgg(final World p_i1780_1_, final EntityLivingBase p_i1780_2_) {
        super(p_i1780_1_, p_i1780_2_);
    }
    
    public EntityEgg(final World p_i1781_1_, final double p_i1781_2_, final double p_i1781_4_, final double p_i1781_6_) {
