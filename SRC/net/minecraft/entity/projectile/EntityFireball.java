...
public abstract class EntityFireball extends Entity
{
    ...
    public EntityFireball(final World p_i1759_1_) {
        super(p_i1759_1_);
    ...
    public EntityFireball(final World p_i1760_1_, final double p_i1760_2_, final double p_i1760_4_, final double p_i1760_6_, final double p_i1760_8_, final double p_i1760_10_, final double p_i1760_12_) {
        super(p_i1760_1_);
        this.field_145795_e = -1;
        this.field_145793_f = -1;
        this.field_145794_g = -1;
    ...
    public EntityFireball(final World p_i1761_1_, final EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_) {
        super(p_i1761_1_);
        this.field_145795_e = -1;
        this.field_145793_f = -1;
        this.field_145794_g = -1;
        ...
        if (!this.worldObj.isClient && ((this.shootingEntity != null && this.shootingEntity.isDead) || !this.worldObj.blockExists((int)this.posX, (int)this.posY, (int)this.posZ))) {
            ...
            for (int var7 = 0; var7 < var5.size(); ++var7) {
                ...
                if (var8.canBeCollidedWith() && (!var8.isEntityEqual(this.shootingEntity) || this.ticksInAir >= 25)) {
                    ...
                    final AxisAlignedBB var10 = var8.boundingBox.expand(var9, var9, var9);
            ...
            if (this.isInWater()) {
                for (int var15 = 0; var15 < 4; ++var15) {
                    ...
                    this.worldObj.spawnParticle("bubble", this.posX - this.motionX * var16, this.posY - this.motionY * var16, this.posZ - this.motionZ * var16, this.motionX, this.motionY, this.motionZ);
                }
                var14 = 0.8f;
            }
