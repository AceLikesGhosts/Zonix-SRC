        ...
        for (int var4 = 0; var4 < 4; ++var4) {
            ...
            this.addSlotToContainer(new Slot(p_i1819_1_, p_i1819_1_.getSizeInventory() - 1 - var4, 8, 8 + var4 * 18) {
                ...
                public boolean isItemValid(final ItemStack p_75214_1_) {
                    return p_75214_1_ != null && ((p_75214_1_.getItem() instanceof ItemArmor) ? (((ItemArmor)p_75214_1_.getItem()).armorType == var6) : ((p_75214_1_.getItem() == Item.getItemFromBlock(Blocks.pumpkin) || p_75214_1_.getItem() == Items.skull) && var6 == 0));
                }
                
                @Override
                public IIcon getBackgroundIconIndex() {
                    return ItemArmor.func_94602_b(var6);
                }
            });
        }
