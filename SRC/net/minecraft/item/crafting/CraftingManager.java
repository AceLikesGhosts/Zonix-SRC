...
public class CraftingManager
{
    ...
    private CraftingManager() {
        ...
        this.addRecipe(new ItemStack(Blocks.planks, 4, 4), "#", '#', new ItemStack(Blocks.log2, 1, 0));
        this.addRecipe(new ItemStack(Blocks.planks, 4, 5), "#", '#', new ItemStack(Blocks.log2, 1, 1));
    ...
    ShapedRecipes addRecipe(final ItemStack p_92103_1_, final Object... p_92103_2_) {
        String var3 = "";
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
    ...
    void addShapelessRecipe(final ItemStack p_77596_1_, final Object... p_77596_2_) {
        final ArrayList var3 = new ArrayList();
        final Object[] var4 = p_77596_2_;
        for (int var5 = p_77596_2_.length, var6 = 0; var6 < var5; ++var6) {
    ...
    public ItemStack findMatchingRecipe(final InventoryCrafting p_82787_1_, final World p_82787_2_) {
        ...
        ItemStack var4 = null;
        ItemStack var5 = null;
        for (int var6 = 0; var6 < p_82787_1_.getSizeInventory(); ++var6) {
            final ItemStack var7 = p_82787_1_.getStackInSlot(var6);
            if (var7 != null) {
                if (var3 == 0) {
                    var4 = var7;
                }
        ...
        if (var3 == 2 && var4.getItem() == var5.getItem() && var4.stackSize == 1 && var5.stackSize == 1 && var4.getItem().isDamageable()) {
            ...
            return new ItemStack(var4.getItem(), 1, var12);
        }
        for (int var6 = 0; var6 < this.recipes.size(); ++var6) {
            final IRecipe var13 = this.recipes.get(var6);
            if (var13.matches(p_82787_1_, p_82787_2_)) {
                return var13.getCraftingResult(p_82787_1_);
            }
        }
        return null;
    }
