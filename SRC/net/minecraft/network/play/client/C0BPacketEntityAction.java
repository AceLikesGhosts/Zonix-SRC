...
public class C0BPacketEntityAction extends Packet
{
    ...
    public C0BPacketEntityAction(final Entity p_i45259_1_, final int p_i45259_2_) {
        this(p_i45259_1_, p_i45259_2_, 0);
    }
    
    public C0BPacketEntityAction(final Entity p_i45260_1_, final int p_i45260_2_, final int p_i45260_3_) {
