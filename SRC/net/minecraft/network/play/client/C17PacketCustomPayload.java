...
public class C17PacketCustomPayload extends Packet
{
    ...
    public C17PacketCustomPayload(final String p_i45248_1_, final ByteBuf p_i45248_2_) {
        this(p_i45248_1_, p_i45248_2_.array());
    }
    
    public C17PacketCustomPayload(final String p_i45249_1_, final byte[] p_i45249_2_) {
    ...
    public void readPacketData(final PacketBuffer p_148837_1_) throws IOException {
        ...
        if (this.field_149560_b > 0 && this.field_149560_b < 32767) {
            p_148837_1_.readBytes(this.field_149561_c = new byte[this.field_149560_b]);
        }
    }
