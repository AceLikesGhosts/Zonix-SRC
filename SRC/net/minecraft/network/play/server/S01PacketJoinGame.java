...
public class S01PacketJoinGame extends Packet
{
    ...
    public S01PacketJoinGame(final int p_i45201_1_, final WorldSettings.GameType p_i45201_2_, final boolean p_i45201_3_, final int p_i45201_4_, final EnumDifficulty p_i45201_5_, final int p_i45201_6_, final WorldType p_i45201_7_) {
    ...
    public String serialize() {
        return String.format("eid=%d, gameType=%d, hardcore=%b, dimension=%d, difficulty=%s, maxplayers=%d", this.field_149206_a, this.field_149205_c.getID(), this.field_149204_b, this.field_149202_d, this.field_149203_e, this.field_149200_f);
    }
