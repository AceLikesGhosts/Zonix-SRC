...
public class S24PacketBlockAction extends Packet
{
    ...
    public S24PacketBlockAction(final int p_i45176_1_, final int p_i45176_2_, final int p_i45176_3_, final Block p_i45176_4_, final int p_i45176_5_, final int p_i45176_6_) {
    ...
    public void readPacketData(final PacketBuffer p_148837_1_) throws IOException {
        ...
        this.field_148871_f = Block.getBlockById(p_148837_1_.readVarIntFromBuffer() & 0xFFF);
    }
    ...
    public void writePacketData(final PacketBuffer p_148840_1_) throws IOException {
        ...
        p_148840_1_.writeVarIntToBuffer(Block.getIdFromBlock(this.field_148871_f) & 0xFFF);
    }
