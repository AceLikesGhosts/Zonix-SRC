...
public class S29PacketSoundEffect extends Packet
{
    ...
    public S29PacketSoundEffect(final String p_i45200_1_, final double p_i45200_2_, final double p_i45200_4_, final double p_i45200_6_, final float p_i45200_8_, final float p_i45200_9_) {
        this.field_149218_c = Integer.MAX_VALUE;
