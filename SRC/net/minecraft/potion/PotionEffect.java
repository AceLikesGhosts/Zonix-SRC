...
public class PotionEffect
{
    ...
    public PotionEffect(final int p_i1574_1_, final int p_i1574_2_) {
        this(p_i1574_1_, p_i1574_2_, 0);
    }
    
    public PotionEffect(final int p_i1575_1_, final int p_i1575_2_, final int p_i1575_3_) {
        this(p_i1575_1_, p_i1575_2_, p_i1575_3_, false);
    }
    
    public PotionEffect(final int p_i1576_1_, final int p_i1576_2_, final int p_i1576_3_, final boolean p_i1576_4_) {
    ...
    public void setSplashPotion(final boolean p_82721_1_) {
    ...
    public boolean onUpdate(final EntityLivingBase p_76455_1_) {
        if (this.duration > 0) {
    ...
    public void performEffect(final EntityLivingBase p_76457_1_) {
        if (this.duration > 0) {
    ...
    public NBTTagCompound writeCustomPotionEffectToNBT(final NBTTagCompound p_82719_1_) {
    ...
    public static PotionEffect readCustomPotionEffectFromNBT(final NBTTagCompound p_82722_0_) {
    ...
    public void setPotionDurationMax(final boolean p_100012_1_) {
