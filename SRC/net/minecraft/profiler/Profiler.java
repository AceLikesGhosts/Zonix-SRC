...
public class Profiler
{
    ...
    public void startSection(final String p_76320_1_) {
        if (this.profilingEnabled) {
            if (this.profilingSection.length() > 0) {
                this.profilingSection += ".";
            }
            this.profilingSection += p_76320_1_;
    ...
    public List getProfilingData(String p_76321_1_) {
        ...
        for (final String var11 : this.profilingMap.keySet()) {
            this.profilingMap.put(var11, this.profilingMap.get(var11) * 999L / 1000L);
        }
        if (var6 > var9) {
    ...
    public void endStartSection(final String p_76318_1_) {
        this.endSection();
