...
public class RealmsScreen
{
    ...
    public void render(final int p_render_1_, final int p_render_2_, final float p_render_3_) {
        for (int var4 = 0; var4 < this.proxy.func_154320_j().size(); ++var4) {
            this.proxy.func_154320_j().get(var4).render(p_render_1_, p_render_2_);
        }
    }
    ...
    public void renderTooltip(final List p_renderTooltip_1_, final int p_renderTooltip_2_, final int p_renderTooltip_3_) {
        this.proxy.func_146283_a(p_renderTooltip_1_, p_renderTooltip_2_, p_renderTooltip_3_);
    }
    
    public static void bindFace(final String p_bindFace_0_) {
    ...
    public RealmsEditBox newEditBox(final int p_newEditBox_1_, final int p_newEditBox_2_, final int p_newEditBox_3_, final int p_newEditBox_4_) {
