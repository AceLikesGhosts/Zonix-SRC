...
public class RealmsServerAddress
{
    ...
    public static RealmsServerAddress parseString(final String p_parseString_0_) {
        ...
        if (p_parseString_0_.startsWith("[")) {
            final int var2 = p_parseString_0_.indexOf("]");
            if (var2 > 0) {
                final String var3 = p_parseString_0_.substring(1, var2);
        ...
        if (var6 == 25565) {
            final String[] var7 = lookupSrv(var5);
            var5 = var7[0];
    ...
    private static String[] lookupSrv(final String p_lookupSrv_0_) {
        try {
            ...
            final Attributes var4 = var3.getAttributes("_minecraft._tcp." + p_lookupSrv_0_, new String[] { "SRV" });
