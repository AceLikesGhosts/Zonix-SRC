...
public abstract class BanEntry extends UserListEntry
{
    ...
    protected void func_152641_a(final JsonObject p_152641_1_) {
        p_152641_1_.addProperty("created", BanEntry.dateFormat.format(this.banStartDate));
        p_152641_1_.addProperty("source", this.bannedBy);
        p_152641_1_.addProperty("expires", (this.banEndDate == null) ? "forever" : BanEntry.dateFormat.format(this.banEndDate));
