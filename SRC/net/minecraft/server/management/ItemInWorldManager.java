...
public class ItemInWorldManager
{
    ...
    public ItemInWorldManager(final World p_i1524_1_) {
    ...
    public void updateBlockRemoving() {
        ...
        if (this.receivedFinishDiggingPacket) {
            ...
            final Block var2 = this.theWorld.getBlock(this.posX, this.posY, this.posZ);
            if (var2.getMaterial() == Material.air) {
                this.receivedFinishDiggingPacket = false;
            }
            else {
                final float var3 = var2.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.posX, this.posY, this.posZ) * (var1 + 1);
            ...
            final Block var5 = this.theWorld.getBlock(this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ);
            if (var5.getMaterial() == Material.air) {
                ...
                final float var3 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ) * (var6 + 1);
                final int var4 = (int)(var3 * 10.0f);
                if (var4 != this.durabilityRemainingOnBlock) {
    ...
    public void onBlockClicked(final int p_73074_1_, final int p_73074_2_, final int p_73074_3_, final int p_73074_4_) {
        if (!this.gameType.isAdventure() || this.thisPlayerMP.isCurrentToolAdventureModeExempt(p_73074_1_, p_73074_2_, p_73074_3_)) {
            if (this.isCreative()) {
                if (!this.theWorld.extinguishFire(null, p_73074_1_, p_73074_2_, p_73074_3_, p_73074_4_)) {
                    this.tryHarvestBlock(p_73074_1_, p_73074_2_, p_73074_3_);
                }
            }
            else {
                this.theWorld.extinguishFire(null, p_73074_1_, p_73074_2_, p_73074_3_, p_73074_4_);
                this.initialDamage = this.curblockDamage;
                float var5 = 1.0f;
                final Block var6 = this.theWorld.getBlock(p_73074_1_, p_73074_2_, p_73074_3_);
    ...
    public void uncheckedTryHarvestBlock(final int p_73082_1_, final int p_73082_2_, final int p_73082_3_) {
        if (p_73082_1_ == this.partiallyDestroyedBlockX && p_73082_2_ == this.partiallyDestroyedBlockY && p_73082_3_ == this.partiallyDestroyedBlockZ) {
            ...
            final Block var5 = this.theWorld.getBlock(p_73082_1_, p_73082_2_, p_73082_3_);
            if (var5.getMaterial() != Material.air) {
                final float var6 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, p_73082_1_, p_73082_2_, p_73082_3_) * (var4 + 1);
                if (var6 >= 0.7f) {
                    this.isDestroyingBlock = false;
    ...
    public void cancelDestroyingBlock(final int p_73073_1_, final int p_73073_2_, final int p_73073_3_) {
        this.isDestroyingBlock = false;
        this.theWorld.destroyBlockInWorldPartially(this.thisPlayerMP.getEntityId(), this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ, -1);
    }
    
    private boolean removeBlock(final int p_73079_1_, final int p_73079_2_, final int p_73079_3_) {
        final Block var4 = this.theWorld.getBlock(p_73079_1_, p_73079_2_, p_73079_3_);
        final int var5 = this.theWorld.getBlockMetadata(p_73079_1_, p_73079_2_, p_73079_3_);
        var4.onBlockHarvested(this.theWorld, p_73079_1_, p_73079_2_, p_73079_3_, var5, this.thisPlayerMP);
        final boolean var6 = this.theWorld.setBlockToAir(p_73079_1_, p_73079_2_, p_73079_3_);
        if (var6) {
    ...
    public boolean tryHarvestBlock(final int p_73084_1_, final int p_73084_2_, final int p_73084_3_) {
        ...
        final Block var4 = this.theWorld.getBlock(p_73084_1_, p_73084_2_, p_73084_3_);
        final int var5 = this.theWorld.getBlockMetadata(p_73084_1_, p_73084_2_, p_73084_3_);
        ...
        final boolean var6 = this.removeBlock(p_73084_1_, p_73084_2_, p_73084_3_);
        if (this.isCreative()) {
            ...
            final boolean var8 = this.thisPlayerMP.canHarvestBlock(var4);
            if (var7 != null) {
    ...
    public boolean tryUseItem(final EntityPlayer p_73085_1_, final World p_73085_2_, final ItemStack p_73085_3_) {
        ...
        final ItemStack var6 = p_73085_3_.useItemRightClick(p_73085_2_, p_73085_1_);
    ...
    public boolean activateBlockOrUseItem(final EntityPlayer p_73078_1_, final World p_73078_2_, final ItemStack p_73078_3_, final int p_73078_4_, final int p_73078_5_, final int p_73078_6_, final int p_73078_7_, final float p_73078_8_, final float p_73078_9_, final float p_73078_10_) {
        ...
        if (this.isCreative()) {
            ...
            final boolean var13 = p_73078_3_.tryPlaceItemIntoWorld(p_73078_1_, p_73078_2_, p_73078_4_, p_73078_5_, p_73078_6_, p_73078_7_, p_73078_8_, p_73078_9_, p_73078_10_);
