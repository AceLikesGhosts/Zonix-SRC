...
{
    public static final SimpleDateFormat field_152659_a;
    ...
    private static GameProfile func_152650_a(final MinecraftServer p_152650_0_, final String p_152650_1_) {
        ...
        if (!p_152650_0_.isServerInOnlineMode() && var2[0] == null) {
            final UUID var4 = EntityPlayer.func_146094_a(new GameProfile((UUID)null, p_152650_1_));
    ...
    private void func_152651_a(final GameProfile p_152651_1_, Date p_152651_2_) {
        ...
        final LinkedList var7 = this.field_152663_e;
        synchronized (this.field_152663_e) {
            if (this.field_152662_d.containsKey(var3)) {
                final ProfileEntry var8 = this.field_152662_d.get(var3);
                this.field_152661_c.remove(var8.func_152668_a().getName().toLowerCase(Locale.ROOT));
    ...
    public GameProfile func_152655_a(final String p_152655_1_) {
        ...
        if (var3 != null && new Date().getTime() >= var3.field_152673_c.getTime()) {
            ...
            final LinkedList var4 = this.field_152663_e;
            synchronized (this.field_152663_e) {
        ...
        if (var3 != null) {
            final GameProfile var5 = var3.func_152668_a();
            final LinkedList var6 = this.field_152663_e;
            synchronized (this.field_152663_e) {
                this.field_152663_e.remove(var5);
                this.field_152663_e.addFirst(var5);
            }
        }
        else {
            final GameProfile var5 = func_152650_a(this.field_152664_f, var2);
            if (var5 != null) {
                this.func_152649_a(var5);
    ...
    public void func_152657_b() {
        ...
        Label_0055: {
            try {
                ...
                var1 = (List)this.field_152660_b.fromJson((Reader)var2, (Type)PlayerProfileCache.field_152666_h);
                break Label_0055;
            }
        ...
        if (var1 != null) {
            ...
            final LinkedList var3 = this.field_152663_e;
            synchronized (this.field_152663_e) {
                this.field_152663_e.clear();
            }
            var1 = Lists.reverse(var1);
            for (final ProfileEntry var5 : var1) {
                if (var5 != null) {
                    this.func_152651_a(var5.func_152668_a(), var5.func_152670_b());
                }
            }
        }
    }
    ...
    public void func_152658_c() {
        final String var1 = this.field_152660_b.toJson((Object)this.func_152656_a(1000));
    ...
    private List func_152656_a(final int p_152656_1_) {
        ...
        synchronized (this.field_152663_e) {
            var4 = Lists.newArrayList(Iterators.limit((Iterator)this.field_152663_e.iterator(), p_152656_1_));
        }
        for (final GameProfile var6 : var4) {
            final ProfileEntry var7 = this.func_152653_b(var6.getId());
            if (var7 != null) {
                var2.add(var7);
            }
        }
    ...
    static {
        field_152659_a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss Z");
