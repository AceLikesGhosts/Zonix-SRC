...
public class Config
{
    ...
    public static void updateThreadPriorities() {
        try {
            ...
            Config.minecraftThread.setPriority(prioMc);
    ...
    public static boolean isOcclusionFancy() {
        return isOcclusionEnabled() && Config.gameSettings.ofOcclusionFancy;
    }
    ...
    public static int getPreloadedChunks() {
        return (int)(FPSBoost.SMART_PERFORMANCE.getValue() / 10.0f);
    }
    ...
    public static int getUpdatesPerFrame() {
        return (int)(FPSBoost.SMART_PERFORMANCE.getValue() / 20.0f);
    }
    
    public static boolean isDynamicUpdates() {
        return FPSBoost.SMART_PERFORMANCE.getValue() >= 30.0f;
    }
    ...
    public static boolean isCloudsOff() {
        return (Config.gameSettings.ofClouds != 0) ? (Config.gameSettings.ofClouds == 3) : (Config.texturePackClouds != 0 && Config.texturePackClouds == 3);
    }
    ...
    public static IIcon getSideGrassTexture(final IBlockAccess blockAccess, int x, int y, int z, final int side, final IIcon icon) {
        if (!isBetterGrass()) {
            return icon;
        }
    ...
    public static IIcon getSideSnowGrassTexture(final IBlockAccess blockAccess, int x, final int y, int z, final int side) {
        if (!isBetterGrass()) {
    ...
    public static boolean isWeatherEnabled() {
        return FPSBoost.WEATHER.getValue();
    }
    ...
    public static int getAnisotropicFilterLevel() {
        return Config.gameSettings.anisotropicFiltering;
    }
    ...
    public static boolean isFastRender() {
        return FPSBoost.SMART_PERFORMANCE.getValue() >= 70.0f;
    }
    ...
    public static int getRandom(final int x, final int y, final int z, final int face) {
    ...
    public static boolean isSmoothWorld() {
        return isSingleProcessor() && Config.gameSettings.ofSmoothWorld;
    }
    ...
    public static void checkDisplaySettings() {
        ...
        if (samples > 0) {
            ...
            if (Util.getOSType() != Util.EnumOS.OSX) {
                ...
                try {
                    var12 = getDefaultResourcePack().getInputStream(new ResourceLocation("icons/icon_16x16.png"));
                    var13 = getDefaultResourcePack().getInputStream(new ResourceLocation("icons/icon_32x32.png"));
                    if (var12 != null && var13 != null) {
                        Display.setIcon(new ByteBuffer[] { readIconImage(var12), readIconImage(var13) });
                    }
                }
                catch (IOException var14) {
                    warn(var14.getClass().getName() + ": " + var14.getMessage());
                }
            }
        }
    }
    ...
    public static void drawFps() {
        final String debugStr = Config.minecraft.debug;
        int pos = debugStr.indexOf(32);
        if (pos < 0) {
            pos = 0;
        }
        final String fps = debugStr.substring(0, pos);
    ...
    public static DynamicTexture getMojangLogoTexture(final DynamicTexture texDefault) {
        try {
            ...
            final DynamicTexture dt = new DynamicTexture(ImageIO.read(in));
            return dt;
        }
        catch (Exception var4) {
