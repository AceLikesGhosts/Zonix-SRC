...
public class ConnectedProperties
{
            ...
            if (i.contains("-")) {
                ...
                if (iconName.length == 2) {
                    ...
                    if (pathBlocks >= 0 && max >= 0) {
                        ...
                        Config.warn("Invalid statusUpdateInterval: " + i + ", when parsing: " + str);
                        continue;
                    }
                }
            }
    ...
    private String[] detectMatchTiles() {
        final IIcon icon = getIcon(this.name);
        return (String[])((icon == null) ? null : new String[] { this.name });
    }
    
    private static IIcon getIcon(final String iconName) {
    ...
    private static IIcon[] registerIcons(final String[] tileNames, final TextureMap textureMap) {
        if (tileNames == null) {
            return null;
        }
        ...
        for (int icons = 0; icons < tileNames.length; ++icons) {
            String fullName;
            final String iconName = fullName = tileNames[icons];
        ...
        final IIcon[] var10 = iconList.toArray(new IIcon[iconList.size()]);
        return var10;
    }
