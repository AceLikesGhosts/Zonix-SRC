...
public class CustomSkyLayer
{
    ...
    private void renderSide(final Tessellator tess, final int side) {
        ...
        tess.addVertexWithUV(-70.0, -70.0, -70.0, tx, ty);
        tess.addVertexWithUV(-70.0, -70.0, 70.0, tx, ty + 0.5);
        tess.addVertexWithUV(70.0, -70.0, 70.0, tx + 0.3333333333333333, ty + 0.5);
        tess.addVertexWithUV(70.0, -70.0, -70.0, tx + 0.3333333333333333, ty);
        tess.draw();
    }
    
    public boolean isActive(final int timeOfDay) {
