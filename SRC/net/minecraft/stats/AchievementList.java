...
public class AchievementList
{
    ...
    static {
        ...
        AchievementList.cookFish = new Achievement("achievement.cookFish", "cookFish", 2, 6, Items.cooked_fished, AchievementList.buildFurnace).registerStat();
        ...
        AchievementList.field_150966_x = new Achievement("achievement.diamondsToYou", "diamondsToYou", -1, 2, Items.diamond, AchievementList.diamonds).registerStat();
        ...
        AchievementList.field_150962_H = new Achievement("achievement.breedCow", "breedCow", 7, -5, Items.wheat, AchievementList.killCow).registerStat();
        AchievementList.field_150963_I = new Achievement("achievement.spawnWither", "spawnWither", 7, 12, new ItemStack(Items.skull, 1, 1), AchievementList.theEnd2).registerStat();
        AchievementList.field_150964_J = new Achievement("achievement.killWither", "killWither", 7, 10, Items.nether_star, AchievementList.field_150963_I).registerStat();
        AchievementList.field_150965_K = new Achievement("achievement.fullBeacon", "fullBeacon", 7, 8, Blocks.beacon, AchievementList.field_150964_J).setSpecial().registerStat();
        AchievementList.field_150961_L = new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.diamond_boots, AchievementList.theEnd).func_150953_b(JsonSerializableSet.class).setSpecial().registerStat();
    }
}
