...
public class TileEntity
{
    ...
    private static void func_145826_a(final Class p_145826_0_, final String p_145826_1_) {
        if (TileEntity.nameToClassMap.containsKey(p_145826_1_)) {
            throw new IllegalArgumentException("Duplicate id: " + p_145826_1_);
        }
        TileEntity.nameToClassMap.put(p_145826_1_, p_145826_0_);
        TileEntity.classToNameMap.put(p_145826_0_, p_145826_1_);
    }
    ...
    public static TileEntity createAndLoadEntity(final NBTTagCompound p_145827_0_) {
        TileEntity var1 = null;
        try {
            final Class var2 = TileEntity.nameToClassMap.get(p_145827_0_.getString("id"));
            if (var2 != null) {
        ...
        if (var1 != null) {
            ...
            TileEntity.logger.warn("Skipping BlockEntity with id " + p_145827_0_.getString("id"));
        }
        return var1;
    }
    ...
    public double getDistanceFrom(final double p_145835_1_, final double p_145835_3_, final double p_145835_5_) {
        final double var7 = this.field_145851_c + 0.5 - p_145835_1_;
        final double var8 = this.field_145848_d + 0.5 - p_145835_3_;
        final double var9 = this.field_145849_e + 0.5 - p_145835_5_;
    ...
    public void func_145828_a(final CrashReportCategory p_145828_1_) {
        ...
        p_145828_1_.addCrashSectionCallable("Actual block type", new Callable() {
            ...
            @Override
            public String call() {
                final int var1 = Block.getIdFromBlock(TileEntity.this.worldObj.getBlock(TileEntity.this.field_145851_c, TileEntity.this.field_145848_d, TileEntity.this.field_145849_e));
                try {
        ...
        p_145828_1_.addCrashSectionCallable("Actual block data value", new Callable() {
            ...
            @Override
            public String call() {
                final int var1 = TileEntity.this.worldObj.getBlockMetadata(TileEntity.this.field_145851_c, TileEntity.this.field_145848_d, TileEntity.this.field_145849_e);
                if (var1 < 0) {
