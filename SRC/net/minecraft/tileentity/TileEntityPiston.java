...
public class TileEntityPiston extends TileEntity
{
    ...
    private List field_145871_o;
    private static final String __OBFID = "CL_00000369";
    
    public TileEntityPiston() {
        this.field_145871_o = new ArrayList();
    }
    
    public TileEntityPiston(final Block p_i45444_1_, final int p_i45444_2_, final int p_i45444_3_, final boolean p_i45444_4_, final boolean p_i45444_5_) {
        this.field_145871_o = new ArrayList();
    ...
    public float func_145865_b(final float p_145865_1_) {
        return this.field_145875_k ? ((this.func_145860_a(p_145865_1_) - 1.0f) * Facing.offsetsXForSide[this.field_145874_j]) : ((1.0f - this.func_145860_a(p_145865_1_)) * Facing.offsetsXForSide[this.field_145874_j]);
    }
    
    public float func_145862_c(final float p_145862_1_) {
        return this.field_145875_k ? ((this.func_145860_a(p_145862_1_) - 1.0f) * Facing.offsetsYForSide[this.field_145874_j]) : ((1.0f - this.func_145860_a(p_145862_1_)) * Facing.offsetsYForSide[this.field_145874_j]);
    }
    
    public float func_145859_d(final float p_145859_1_) {
        return this.field_145875_k ? ((this.func_145860_a(p_145859_1_) - 1.0f) * Facing.offsetsZForSide[this.field_145874_j]) : ((1.0f - this.func_145860_a(p_145859_1_)) * Facing.offsetsZForSide[this.field_145874_j]);
    }
    ...
    private void func_145863_a(float p_145863_1_, final float p_145863_2_) {
        ...
        final AxisAlignedBB var3 = Blocks.piston_extension.func_149964_a(this.worldObj, this.field_145851_c, this.field_145848_d, this.field_145849_e, this.field_145869_a, p_145863_1_, this.field_145874_j);
        if (var3 != null) {
            final List var4 = this.worldObj.getEntitiesWithinAABBExcludingEntity(null, var3);
            if (!var4.isEmpty()) {
                this.field_145871_o.addAll(var4);
                for (final Entity var6 : this.field_145871_o) {
                    var6.moveEntity(p_145863_2_ * Facing.offsetsXForSide[this.field_145874_j], p_145863_2_ * Facing.offsetsYForSide[this.field_145874_j], p_145863_2_ * Facing.offsetsZForSide[this.field_145874_j]);
                }
    ...
    public void func_145866_f() {
        if (this.field_145870_n < 1.0f && this.worldObj != null) {
            final float n = 1.0f;
            this.field_145873_m = n;
            this.field_145870_n = n;
    ...
    public void readFromNBT(final NBTTagCompound p_145839_1_) {
        ...
        final float float1 = p_145839_1_.getFloat("progress");
        this.field_145873_m = float1;
        this.field_145870_n = float1;
