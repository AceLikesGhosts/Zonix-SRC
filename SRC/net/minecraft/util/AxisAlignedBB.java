...
public class AxisAlignedBB
{
    ...
    public static AxisAlignedBB getBoundingBox(final double p_72330_0_, final double p_72330_2_, final double p_72330_4_, final double p_72330_6_, final double p_72330_8_, final double p_72330_10_) {
        return new AxisAlignedBB(p_72330_0_, p_72330_2_, p_72330_4_, p_72330_6_, p_72330_8_, p_72330_10_);
    }
    
    protected AxisAlignedBB(final double p_i2300_1_, final double p_i2300_3_, final double p_i2300_5_, final double p_i2300_7_, final double p_i2300_9_, final double p_i2300_11_) {
    ...
    public AxisAlignedBB setBounds(final double p_72324_1_, final double p_72324_3_, final double p_72324_5_, final double p_72324_7_, final double p_72324_9_, final double p_72324_11_) {
    ...
    public AxisAlignedBB addCoord(final double p_72321_1_, final double p_72321_3_, final double p_72321_5_) {
        ...
        return getBoundingBox(var7, var8, var9, var10, var11, var12);
    }
    
    public AxisAlignedBB expand(final double p_72314_1_, final double p_72314_3_, final double p_72314_5_) {
        final double var7 = this.minX - p_72314_1_;
        final double var8 = this.minY - p_72314_3_;
        final double var9 = this.minZ - p_72314_5_;
        final double var10 = this.maxX + p_72314_1_;
        final double var11 = this.maxY + p_72314_3_;
        final double var12 = this.maxZ + p_72314_5_;
        return getBoundingBox(var7, var8, var9, var10, var11, var12);
    }
    
    public AxisAlignedBB func_111270_a(final AxisAlignedBB p_111270_1_) {
        final double var2 = Math.min(this.minX, p_111270_1_.minX);
        final double var3 = Math.min(this.minY, p_111270_1_.minY);
        final double var4 = Math.min(this.minZ, p_111270_1_.minZ);
        final double var5 = Math.max(this.maxX, p_111270_1_.maxX);
        final double var6 = Math.max(this.maxY, p_111270_1_.maxY);
        final double var7 = Math.max(this.maxZ, p_111270_1_.maxZ);
        return getBoundingBox(var2, var3, var4, var5, var6, var7);
    }
    
    public AxisAlignedBB getOffsetBoundingBox(final double p_72325_1_, final double p_72325_3_, final double p_72325_5_) {
    ...
    public double calculateXOffset(final AxisAlignedBB p_72316_1_, double p_72316_2_) {
        if (p_72316_1_.maxY <= this.minY || p_72316_1_.minY >= this.maxY) {
            return p_72316_2_;
        }
        if (p_72316_1_.maxZ > this.minZ && p_72316_1_.minZ < this.maxZ) {
            if (p_72316_2_ > 0.0 && p_72316_1_.maxX <= this.minX) {
                final double var4 = this.minX - p_72316_1_.maxX;
                if (var4 < p_72316_2_) {
                    p_72316_2_ = var4;
                }
            }
            if (p_72316_2_ < 0.0 && p_72316_1_.minX >= this.maxX) {
                final double var4 = this.maxX - p_72316_1_.minX;
                if (var4 > p_72316_2_) {
                    p_72316_2_ = var4;
                }
            }
    ...
    public double calculateYOffset(final AxisAlignedBB p_72323_1_, double p_72323_2_) {
        if (p_72323_1_.maxX <= this.minX || p_72323_1_.minX >= this.maxX) {
            return p_72323_2_;
        }
        if (p_72323_1_.maxZ > this.minZ && p_72323_1_.minZ < this.maxZ) {
            if (p_72323_2_ > 0.0 && p_72323_1_.maxY <= this.minY) {
                final double var4 = this.minY - p_72323_1_.maxY;
                if (var4 < p_72323_2_) {
                    p_72323_2_ = var4;
                }
            }
            if (p_72323_2_ < 0.0 && p_72323_1_.minY >= this.maxY) {
                final double var4 = this.maxY - p_72323_1_.minY;
                if (var4 > p_72323_2_) {
                    p_72323_2_ = var4;
                }
            }
    ...
    public double calculateZOffset(final AxisAlignedBB p_72322_1_, double p_72322_2_) {
        if (p_72322_1_.maxX <= this.minX || p_72322_1_.minX >= this.maxX) {
            return p_72322_2_;
        }
        if (p_72322_1_.maxY > this.minY && p_72322_1_.minY < this.maxY) {
            if (p_72322_2_ > 0.0 && p_72322_1_.maxZ <= this.minZ) {
                final double var4 = this.minZ - p_72322_1_.maxZ;
                if (var4 < p_72322_2_) {
                    p_72322_2_ = var4;
                }
            }
            if (p_72322_2_ < 0.0 && p_72322_1_.minZ >= this.maxZ) {
                final double var4 = this.maxZ - p_72322_1_.minZ;
                if (var4 > p_72322_2_) {
                    p_72322_2_ = var4;
                }
            }
    ...
    public boolean intersectsWith(final AxisAlignedBB p_72326_1_) {
    ...
    public AxisAlignedBB offset(final double p_72317_1_, final double p_72317_3_, final double p_72317_5_) {
    ...
    public boolean isVecInside(final Vec3 p_72318_1_) {
    ...
    public AxisAlignedBB contract(final double p_72331_1_, final double p_72331_3_, final double p_72331_5_) {
        final double var7 = this.minX + p_72331_1_;
        final double var8 = this.minY + p_72331_3_;
        final double var9 = this.minZ + p_72331_5_;
        final double var10 = this.maxX - p_72331_1_;
        final double var11 = this.maxY - p_72331_3_;
        final double var12 = this.maxZ - p_72331_5_;
        return getBoundingBox(var7, var8, var9, var10, var11, var12);
    }
    ...
    private boolean isVecInYZ(final Vec3 p_72333_1_) {
    ...
    private boolean isVecInXZ(final Vec3 p_72315_1_) {
    ...
    private boolean isVecInXY(final Vec3 p_72319_1_) {
    ...
    public void setBB(final AxisAlignedBB p_72328_1_) {
