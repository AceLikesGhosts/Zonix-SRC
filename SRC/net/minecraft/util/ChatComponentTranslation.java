...
public class ChatComponentTranslation extends ChatComponentStyle
{
    ...
    public ChatComponentTranslation(final String p_i45160_1_, final Object... p_i45160_2_) {
        ...
        for (int var4 = p_i45160_2_.length, var5 = 0; var5 < var4; ++var5) {
    ...
    protected void initializeFromFormat(final String p_150269_1_) {
        final boolean var2 = false;
        final Matcher var3 = ChatComponentTranslation.stringVariablePattern.matcher(p_150269_1_);
        int var4 = 0;
        int var5 = 0;
        try {
            while (var3.find(var5)) {
                ...
                if (var6 > var5) {
                    final ChatComponentText var8 = new ChatComponentText(String.format(p_150269_1_.substring(var5, var6), new Object[0]));
                    var8.getChatStyle().setParentStyle(this.getChatStyle());
                    this.children.add(var8);
                }
                final String var9 = var3.group(2);
                final String var10 = p_150269_1_.substring(var6, var7);
            ...
            if (var5 < p_150269_1_.length()) {
                final ChatComponentText var14 = new ChatComponentText(String.format(p_150269_1_.substring(var5), new Object[0]));
    ...
    private IChatComponent getFormatArgumentAsComponent(final int p_150272_1_) {
        if (p_150272_1_ >= this.formatArgs.length) {
            throw new ChatComponentTranslationFormatException(this, p_150272_1_);
        }
        final Object var2 = this.formatArgs[p_150272_1_];
        Object var3;
