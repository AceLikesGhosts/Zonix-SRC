...
public class ChunkCoordinates implements Comparable
{
    ...
    public ChunkCoordinates(final int p_i1354_1_, final int p_i1354_2_, final int p_i1354_3_) {
        this.posX = p_i1354_1_;
        this.posY = p_i1354_2_;
        this.posZ = p_i1354_3_;
    }
    
    public ChunkCoordinates(final ChunkCoordinates p_i1355_1_) {
    ...
    public int compareTo(final ChunkCoordinates p_compareTo_1_) {
    ...
    public void set(final int p_71571_1_, final int p_71571_2_, final int p_71571_3_) {
        this.posX = p_71571_1_;
        this.posY = p_71571_2_;
        this.posZ = p_71571_3_;
    }
    
    public float getDistanceSquared(final int p_71569_1_, final int p_71569_2_, final int p_71569_3_) {
        final float var4 = (float)(this.posX - p_71569_1_);
        final float var5 = (float)(this.posY - p_71569_2_);
        final float var6 = (float)(this.posZ - p_71569_3_);
        return var4 * var4 + var5 * var5 + var6 * var6;
    }
    
    public float getDistanceSquaredToChunkCoordinates(final ChunkCoordinates p_82371_1_) {
