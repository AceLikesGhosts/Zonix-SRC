...
public class CombatTracker
{
    ...
    public void func_94545_a() {
        ...
        if (this.fighter.isOnLadder()) {
            final Block var1 = this.fighter.worldObj.getBlock(MathHelper.floor_double(this.fighter.posX), MathHelper.floor_double(this.fighter.boundingBox.minY), MathHelper.floor_double(this.fighter.posZ));
            ...
            if (var1.getDamageSrc() != DamageSource.fall && var1.getDamageSrc() != DamageSource.outOfWorld) {
                if (var5 != null && (var3 == null || !var5.equals(var3))) {
                    ...
                    if (var7 != null && var7.hasDisplayName()) {
                        var8 = new ChatComponentTranslation("death.fell.assist.item", new Object[] { this.fighter.func_145748_c_(), var5, var7.func_151000_E() });
                    }
                    else {
                        var8 = new ChatComponentTranslation("death.fell.assist", new Object[] { this.fighter.func_145748_c_(), var5 });
                    }
                }
                else if (var3 != null) {
                    ...
                    if (var9 != null && var9.hasDisplayName()) {
                        var8 = new ChatComponentTranslation("death.fell.finish.item", new Object[] { this.fighter.func_145748_c_(), var3, var9.func_151000_E() });
                    }
                    else {
                        var8 = new ChatComponentTranslation("death.fell.finish", new Object[] { this.fighter.func_145748_c_(), var3 });
                    }
                }
                else {
                    var8 = new ChatComponentTranslation("death.fell.killer", new Object[] { this.fighter.func_145748_c_() });
                }
            }
            else {
                var8 = new ChatComponentTranslation("death.fell.accident." + this.func_94548_b(var1), new Object[] { this.fighter.func_145748_c_() });
            }
        }
        else {
            var8 = var2.getDamageSrc().func_151519_b(this.fighter);
        }
