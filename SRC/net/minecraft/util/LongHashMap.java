...
public class LongHashMap
{
    ...
    public LongHashMap() {
        this.hashArray = new Entry[16];
        this.capacity = 12;
    }
    
    private static int getHashedKey(final long p_76155_0_) {
    ...
    public Object getValueByKey(final long p_76164_1_) {
        ...
        for (Entry var4 = this.hashArray[getHashIndex(var3, this.hashArray.length)]; var4 != null; var4 = var4.nextEntry) {
    ...
    private void resizeTable(final int p_76153_1_) {
        ...
        if (var3 == 1073741824) {
            ...
            this.hashArray = var4;
            final float n = (float)p_76153_1_;
            this.getClass();
            this.capacity = (int)(n * 0.75f);
        }
    }
