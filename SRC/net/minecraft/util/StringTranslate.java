...
public class StringTranslate
{
    ...
    public StringTranslate() {
        ...
        try {
            final InputStream var1 = StringTranslate.class.getClassLoader().getResourceAsStream("/assets/minecraft/lang/en_US.lang");
            if (var1 == null) {
                return;
            }
    ...
    public synchronized boolean containsTranslateKey(final String p_94520_1_) {
