...
public class NoiseGeneratorPerlin extends NoiseGenerator
{
    ...
    public double func_151601_a(final double p_151601_1_, final double p_151601_3_) {
        double var5 = 0.0;
        double var6 = 1.0;
        for (int var7 = 0; var7 < this.field_151602_b; ++var7) {
            var5 += this.field_151603_a[var7].func_151605_a(p_151601_1_ * var6, p_151601_3_ * var6) / var6;
            var6 /= 2.0;
        }
        return var5;
    }
    ...
    public double[] func_151600_a(double[] p_151600_1_, final double p_151600_2_, final double p_151600_4_, final int p_151600_6_, final int p_151600_7_, final double p_151600_8_, final double p_151600_10_, final double p_151600_12_, final double p_151600_14_) {
        ...
        double var17 = 1.0;
        double var18 = 1.0;
        for (int var19 = 0; var19 < this.field_151602_b; ++var19) {
            this.field_151603_a[var19].func_151606_a(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_, p_151600_8_ * var18 * var17, p_151600_10_ * var18 * var17, 0.55 / var17);
            var18 *= p_151600_12_;
            var17 *= p_151600_14_;
        }
        return p_151600_1_;
