...
public class WorldGenMegaJungle extends WorldGenHugeTrees
{
    ...
    public boolean generate(final World p_76484_1_, final Random p_76484_2_, final int p_76484_3_, final int p_76484_4_, final int p_76484_5_) {
        final int var6 = this.func_150533_a(p_76484_2_);
        ...
        for (int var7 = p_76484_4_ + var6 - 2 - p_76484_2_.nextInt(4); var7 > p_76484_4_ + var6 / 2; var7 -= 2 + p_76484_2_.nextInt(4)) {
            final float var8 = p_76484_2_.nextFloat() * 3.1415927f * 2.0f;
            int var9 = p_76484_3_ + (int)(0.5f + MathHelper.cos(var8) * 4.0f);
            int var10 = p_76484_5_ + (int)(0.5f + MathHelper.sin(var8) * 4.0f);
            for (int var11 = 0; var11 < 5; ++var11) {
                var9 = p_76484_3_ + (int)(1.5f + MathHelper.cos(var8) * var11);
                var10 = p_76484_5_ + (int)(1.5f + MathHelper.sin(var8) * var11);
                this.func_150516_a(p_76484_1_, var9, var7 - 3 + var11 / 2, var10, Blocks.log, this.woodMetadata);
            }
            int var11 = 1 + p_76484_2_.nextInt(2);
            for (int var12 = var7, var13 = var7 - var11; var13 <= var12; ++var13) {
                final int var14 = var13 - var12;
    ...
    private void func_150543_c(final World p_150543_1_, final int p_150543_2_, final int p_150543_3_, final int p_150543_4_, final int p_150543_5_, final Random p_150543_6_) {
        final byte var7 = 2;
        for (int var8 = p_150543_4_ - var7; var8 <= p_150543_4_; ++var8) {
            final int var9 = var8 - p_150543_4_;
