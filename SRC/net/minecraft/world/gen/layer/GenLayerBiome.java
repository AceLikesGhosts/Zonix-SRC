...
public class GenLayerBiome extends GenLayer
{
    ...
    public GenLayerBiome(final long p_i2122_1_, final GenLayer p_i2122_3_, final WorldType p_i2122_4_) {
        super(p_i2122_1_);
    ...
    public int[] getInts(final int p_75904_1_, final int p_75904_2_, final int p_75904_3_, final int p_75904_4_) {
        final int[] var5 = this.parent.getInts(p_75904_1_, p_75904_2_, p_75904_3_, p_75904_4_);
        ...
        for (int var7 = 0; var7 < p_75904_4_; ++var7) {
            for (int var8 = 0; var8 < p_75904_3_; ++var8) {
                ...
                var9 &= 0xFFFFF0FF;
                if (GenLayer.func_151618_b(var9)) {
