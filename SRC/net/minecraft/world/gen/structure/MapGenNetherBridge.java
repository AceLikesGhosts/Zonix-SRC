...
public class MapGenNetherBridge extends MapGenStructure
{
    ...
    public MapGenNetherBridge() {
        (this.spawnList = new ArrayList()).add(new BiomeGenBase.SpawnListEntry(EntityBlaze.class, 10, 2, 3));
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(final World p_i2040_1_, final Random p_i2040_2_, final int p_i2040_3_, final int p_i2040_4_) {
