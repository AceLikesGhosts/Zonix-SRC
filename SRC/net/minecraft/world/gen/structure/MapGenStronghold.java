...
public class MapGenStronghold extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(final int p_75047_1_, final int p_75047_2_) {
        if (!this.ranBiomeCheck) {
            ...
            for (int var6 = 0; var6 < this.structureCoords.length; ++var6) {
                ...
                final ChunkPosition var10 = this.worldObj.getWorldChunkManager().func_150795_a((var8 << 4) + 8, (var9 << 4) + 8, 112, this.field_151546_e, var3);
                if (var10 != null) {
                    var8 = var10.field_151329_a >> 4;
                    var9 = var10.field_151328_c >> 4;
                }
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(final World p_i2067_1_, final Random p_i2067_2_, final int p_i2067_3_, final int p_i2067_4_) {
