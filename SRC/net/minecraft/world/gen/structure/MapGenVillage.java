...
public class MapGenVillage extends MapGenStructure
{
    ...
    static {
        villageSpawnBiomes = Arrays.asList(BiomeGenBase.plains, BiomeGenBase.desert, BiomeGenBase.field_150588_X);
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(final World p_i2092_1_, final Random p_i2092_2_, final int p_i2092_3_, final int p_i2092_4_, final int p_i2092_5_) {
            ...
            final StructureVillagePieces.Start var7 = new StructureVillagePieces.Start(p_i2092_1_.getWorldChunkManager(), 0, p_i2092_2_, (p_i2092_3_ << 4) + 2, (p_i2092_4_ << 4) + 2, var6, p_i2092_5_);
