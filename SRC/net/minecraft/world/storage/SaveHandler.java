...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public SaveHandler(final File p_i2146_1_, final String p_i2146_2_, final boolean p_i2146_3_) {
        this.initializationTime = MinecraftServer.getSystemTimeMillis();
    ...
    public void writePlayerData(final EntityPlayer p_75753_1_) {
        try {
            ...
            SaveHandler.logger.warn("Failed to save player data for " + p_75753_1_.getCommandSenderName());
        }
    }
    ...
    public NBTTagCompound readPlayerData(final EntityPlayer p_75752_1_) {
        ...
        try {
            ...
            SaveHandler.logger.warn("Failed to load player data for " + p_75752_1_.getCommandSenderName());
        }
        if (var2 != null) {
