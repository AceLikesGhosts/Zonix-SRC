...
public class WorldInfo
{
    ...
    public WorldInfo(final NBTTagCompound p_i2157_1_) {
        this.terrainType = WorldType.DEFAULT;
        this.generatorOptions = "";
        this.theGameRules = new GameRules();
    ...
    public WorldInfo(final WorldSettings p_i2158_1_, final String p_i2158_2_) {
        this.terrainType = WorldType.DEFAULT;
        this.generatorOptions = "";
        this.theGameRules = new GameRules();
    ...
    private void updateTagCompound(final NBTTagCompound p_76064_1_, final NBTTagCompound p_76064_2_) {
    ...
    public void setGameType(final WorldSettings.GameType p_76060_1_) {
    ...
    public void addToCrashReport(final CrashReportCategory p_85118_1_) {
