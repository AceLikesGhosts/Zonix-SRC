...
public class ZFont
{
    ...
    public ZFont(final ResourceLocation resourceLocation, final float size) {
    ...
    private BufferedImage generateFontImage(final Font font, final boolean antiAlias, final boolean fractionalMetrics, final CharData[] chars) {
